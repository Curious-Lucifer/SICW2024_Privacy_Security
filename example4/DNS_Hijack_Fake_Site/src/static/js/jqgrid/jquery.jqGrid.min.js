...
!function(a) {
      ...
      gridUnload: function(a) {
          if (a) {
              ...
              if (b.grid) {
                  ...
                  $(d).removeClass("ui-jqgrid-btable").insertBefore("#gbox_" + e),
  ...
  $.fn.jqGrid = function(a) {
      ...
      return this.each(function() {
          if (!this.grid) {
                ...
                , e = {
                  ...
                  dragMove: function(a) {
                      if (this.resizing) {
                          ...
                          g > c.minColWidth && (this.curGbox.css({
              ...
              var j = $("<div class='ui-jqgrid-view' role='grid'></div>")
                , k = []
                , l = []
                , m = []
                , n = $.jgrid.msie;
              ...
              h = d.p.direction,
              $(j).insertBefore(this),
              $(this).removeClass("scroll").appendTo(j);
              var o = $("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");
              $(o).attr({
                  id: "gbox_" + this.id,
                  dir: h
              }).insertBefore(j),
              $(j).attr("id", "gview_" + this.id).appendTo(o),
              $("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(j),
              $("<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(j),
              $(this).attr({
                  cellspacing: "0",
                  cellpadding: "0",
                  border: "0",
              ...
              var p, q = ["shiftKey", "altKey", "ctrlKey"], r = function(a, b) {
                  return a = parseInt(a, 10),
                  isNaN(a) ? b || 0 : a
              }, s = function(a, b, c, f, g, h) {
                  ...
                  if (void 0 !== h.formatter) {
                      ...
                      g = $.isFunction(h.formatter) ? h.formatter.call(d, b, i, e, f) : $.fmatter ? $.fn.fmatter.call(d, h.formatter, b, i, e, f) : t(b)
                  } else
                      g = t(b);
                  return g
              }, v = function(a, b, c, d, e, f) {
                  var g, h;
                  return g = u(a, b, c, e, "add"),
                  h = s(c, d, g, e, a, f),
                  '<td role="gridcell" ' + h + ">" + g + "</td>"
              }, w = function(a, b, c, e) {
                  var f = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" class="cbox" name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>"
                    , g = s(b, c, "", null, a, !0);
                  ...
                  var h, i = "-1", j = "", k = b ? "display:none;" : "", l = "ui-widget-content jqgrow ui-row-" + d.p.direction + (c ? " " + c : "") + (g ? " ui-state-highlight" : ""), m = $(d).triggerHandler("jqGridRowAttr", [e, f, a]);
                  if ("object" != typeof m && (m = $.isFunction(d.p.rowattr) ? d.p.rowattr.call(d, e, f, a) : "string" == typeof d.p.rowattr && null != $.jgrid.rowattr && $.isFunction($.jgrid.rowattr[d.p.rowattr]) ? $.jgrid.rowattr[d.p.rowattr].call(d, e, f, a) : {}),
                  !$.isEmptyObject(m)) {
                      m.hasOwnProperty("id") && (a = m.id,
                      delete m.id),
                      m.hasOwnProperty("tabindex") && (i = m.tabindex,
                      delete m.tabindex),
                      m.hasOwnProperty("style") && (k += m.style,
                      delete m.style),
                      m.hasOwnProperty("class") && (l += " " + m["class"],
                      delete m["class"]);
                      try {
                          delete m.role
                      } catch (n) {}
                  ...
                  d.p.reccount = 0,
                  $.isXMLDoc(a)) {
                      -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (A.call(d, !1, !0),
                      b = 1);
                      var k, l, m, n, o, p, q, s, t, u, B = $(d), C = 0, E = d.p.multiselect === !0 ? 1 : 0, F = 0, G = d.p.rownumbers === !0 ? 1 : 0, H = [], I = {}, J = [], K = d.p.altRows === !0 ? d.p.altclass : "";
                      d.p.subGrid === !0 && (F = 1,
                      n = $.jgrid.getMethod("addSubGridCell")),
                      i.repeatitems || (H = y(j)),
                      o = d.p.keyName === !1 ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName,
                      p = -1 === String(o).indexOf("[") ? H.length ? function(a, b) {
                          return $(o, a).text() || b
                      }
                      : function(a, b) {
                          return $(i.cell, a).eq(o).text() || b
                      }
                      : function(a, b) {
                      ...
                      ,
                      d.p.userData = {},
                      d.p.page = r($.jgrid.getXmlData(a, i.page), d.p.page),
                      d.p.lastpage = r($.jgrid.getXmlData(a, i.total), 1),
                      d.p.records = r($.jgrid.getXmlData(a, i.records)),
                      ...
                      L = $.jgrid.getXmlData(L, i.row, !0),
                      L || (L = []);
                      var M, N = L.length, O = 0, P = [], Q = parseInt(d.p.rowNum, 10), R = d.p.scroll ? $.jgrid.randId() : 1;
                      if (N > 0 && d.p.page <= 0 && (d.p.page = 1),
                      L && N) {
                          e && (Q *= e + 1);
                          var S, T = $.isFunction(d.p.afterInsertRow), U = !1, V = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first");
                          for (d.p.grouping && (U = d.p.groupingView.groupCollapse === !0,
                          S = $.jgrid.getMethod("groupingPrepare")); N > O; ) {
                              s = L[O],
                              t = p(s, R + O),
                              t = d.p.idPrefix + t,
                              M = 0 === b ? 0 : b + 1,
                              ...
                              var W = J.length;
                              if (J.push(""),
                              G && J.push(x(0, O, d.p.page, d.p.rowNum)),
                              E && J.push(w(t, G, O, !1)),
                              F && J.push(n.call(B, E + G, O + b)),
                              i.repeatitems) {
                                  q || (q = z(E + F + G));
                                  var X = $.jgrid.getXmlData(s, i.cell, !0);
                                  $.each(q, function(a) {
                                      var c = X[this];
                                      return c ? (m = c.textContent || c.text,
                                      I[d.p.colModel[a + E + F + G].name] = m,
                                      void J.push(v(t, m, a + E + F + G, O + b, s, I))) : !1
                                  })
                              } else
                                  for (k = 0; k < H.length; k++)
                                      m = $.jgrid.getXmlData(s, H[k]),
                                      I[d.p.colModel[k + E + F + G].name] = m,
                                      J.push(v(t, m, k + E + F + G, O + b, s, I));
                              if (J[W] = D(t, U, u, I, s, !1),
                              J.push("</tr>"),
                              d.p.grouping && (P.push(J),
                              d.p.groupingView._locgr || S.call(B, I, O),
                              J = []),
                              (g || d.p.treeGrid === !0 && !d.p._ald) && (I[h] = $.jgrid.stripPref(d.p.idPrefix, t),
                              d.p.data.push(I),
                              d.p._index[I[h]] = d.p.data.length - 1),
                              d.p.gridview === !1 && (V.append(J.join("")),
                              B.triggerHandler("jqGridAfterInsertRow", [t, I, s]),
                              T && d.p.afterInsertRow.call(d, t, I, s),
                              J = []),
                              I = {},
                              C++,
                              O++,
                      ...
                      if (d.p.gridview === !0 && (l = d.p.treeANode > -1 ? d.p.treeANode : 0,
                      d.p.grouping ? g || (B.jqGrid("groupingRender", P, d.p.colModel.length, d.p.page, Q),
                      P = null) : d.p.treeGrid === !0 && l > 0 ? $(d.rows[l]).after(J.join("")) : (V.append(J.join("")),
                      d.grid.cols = d.rows[0].cells)),
                      d.p.subGrid === !0)
                          try {
                              B.jqGrid("addSubGrid", E + G)
                          } catch (Y) {}
                      if (d.p.totaltime = new Date - f,
                      C > 0 && 0 === d.p.records && (d.p.records = N),
                      J = null,
                      d.p.treeGrid === !0)
                          try {
                              B.jqGrid("setTreeNode", l + 1, C + l + 1)
                          } catch (Z) {}
                      if (d.p.reccount = C,
                      d.p.treeANode = -1,
                      d.p.userDataOnFooter && B.jqGrid("footerData", "set", d.p.userData, !0),
                      g && (d.p.records = N,
                      d.p.lastpage = Math.ceil(N / Q)),
                      c || d.updatepager(!1, !0),
                      g) {
                          for (; N > C; ) {
                              if (s = L[C],
                              ...
                              i.repeatitems) {
                                  q || (q = z(E + F + G));
                                  var _ = $.jgrid.getXmlData(s, i.cell, !0);
                                  $.each(q, function(a) {
                                      var b = _[this];
                                      return b ? (m = b.textContent || b.text,
                                      void (I[d.p.colModel[a + E + F + G].name] = m)) : !1
                                  })
                              } else
                                  for (k = 0; k < H.length; k++)
                                      m = $.jgrid.getXmlData(s, H[k]),
                                      I[d.p.colModel[k + E + F + G].name] = m;
                              I[h] = $.jgrid.stripPref(d.p.idPrefix, t),
                              d.p.grouping && S.call(B, I, C),
                              d.p.data.push(I),
                              d.p._index[I[h]] = d.p.data.length - 1,
                              I = {},
                              C++
                          ...
                          B.jqGrid("groupingRender", P, d.p.colModel.length, d.p.page, Q),
                          P = null)
                      }
                  }
              }, F = function(a, b, c, e) {
                  ...
                  if (a) {
                      ...
                      h = "json");
                      var k, l, m, n, o, p, q, s, t, u, B, C, E = $(d), F = 0, G = [], H = d.p.multiselect ? 1 : 0, I = d.p.subGrid === !0 ? 1 : 0, J = d.p.rownumbers === !0 ? 1 : 0, K = z(H + I + J), L = y(h), M = {}, N = [], O = d.p.altRows === !0 ? d.p.altclass : "";
                      d.p.page = r($.jgrid.getAccessor(a, g.page), d.p.page),
                      d.p.lastpage = r($.jgrid.getAccessor(a, g.total), 1),
                      d.p.records = r($.jgrid.getAccessor(a, g.records)),
                      d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {},
                      I && (o = $.jgrid.getMethod("addSubGridCell")),
                      t = d.p.keyName === !1 ? $.isFunction(g.id) ? g.id.call(d, a) : g.id : d.p.keyName,
                      s = $.jgrid.getAccessor(a, g.root),
                      null == s && $.isArray(a) && (s = a),
                      s || (s = []),
                      q = s.length,
                      l = 0,
                      q > 0 && d.p.page <= 0 && (d.p.page = 1);
                      var P, Q, R = parseInt(d.p.rowNum, 10), S = d.p.scroll ? $.jgrid.randId() : 1, T = !1;
                      e && (R *= e + 1),
                      "local" !== d.p.datatype || d.p.deselectAfterSort || (T = !0);
                      var U, V = $.isFunction(d.p.afterInsertRow), W = [], X = !1, Y = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first");
                      for (d.p.grouping && (X = d.p.groupingView.groupCollapse === !0,
                      U = $.jgrid.getMethod("groupingPrepare")); q > l; ) {
                          if (n = s[l],
                          B = $.jgrid.getAccessor(n, t),
                          void 0 === B && ("number" == typeof t && null != d.p.colModel[t + H + I + J] && (B = $.jgrid.getAccessor(n, d.p.colModel[t + H + I + J].name)),
                          void 0 === B && (B = S + l,
                          0 === G.length && g.cell))) {
                              var Z = $.jgrid.getAccessor(n, g.cell) || n;
                              B = null != Z && void 0 !== Z[t] ? Z[t] : B,
                              Z = null
                          }
                          B = d.p.idPrefix + B,
                          P = 1 === b ? 0 : b,
                          C = (P + l) % 2 === 1 ? O : "",
                          T && (Q = d.p.multiselect ? -1 !== $.inArray(B, d.p.selarrrow) : B === d.p.selrow);
                          var _ = N.length;
                          for (N.push(""),
                          J && N.push(x(0, l, d.p.page, d.p.rowNum)),
                          H && N.push(w(B, J, l, Q)),
                          I && N.push(o.call(E, H + J, l + b)),
                          p = L,
                          g.repeatitems && (g.cell && (n = $.jgrid.getAccessor(n, g.cell) || n),
                          $.isArray(n) && (p = K)),
                          m = 0; m < p.length; m++)
                              k = $.jgrid.getAccessor(n, p[m]),
                              M[d.p.colModel[m + H + I + J].name] = k,
                              N.push(v(B, k, m + H + I + J, l + b, n, M));
                          if (N[_] = D(B, X, C, M, n, Q),
                          N.push("</tr>"),
                          d.p.grouping && (W.push(N),
                          d.p.groupingView._locgr || U.call(E, M, l),
                          N = []),
                          (j || d.p.treeGrid === !0 && !d.p._ald) && (M[i] = $.jgrid.stripPref(d.p.idPrefix, B),
                          d.p.data.push(M),
                          d.p._index[M[i]] = d.p.data.length - 1),
                          d.p.gridview === !1 && (Y.append(N.join("")),
                          E.triggerHandler("jqGridAfterInsertRow", [B, M, n]),
                          V && d.p.afterInsertRow.call(d, B, M, n),
                          N = []),
                          M = {},
                          F++,
                          l++,
                      ...
                      if (d.p.gridview === !0 && (u = d.p.treeANode > -1 ? d.p.treeANode : 0,
                      d.p.grouping ? j || (E.jqGrid("groupingRender", W, d.p.colModel.length, d.p.page, R),
                      W = null) : d.p.treeGrid === !0 && u > 0 ? $(d.rows[u]).after(N.join("")) : (Y.append(N.join("")),
                      d.grid.cols = d.rows[0].cells)),
                      d.p.subGrid === !0)
                          try {
                      ...
                      if (d.p.totaltime = new Date - f,
                      F > 0 && 0 === d.p.records && (d.p.records = q),
                      N = null,
                      d.p.treeGrid === !0)
                          try {
                              E.jqGrid("setTreeNode", u + 1, F + u + 1)
                          } catch (bb) {}
                      if (d.p.reccount = F,
                      d.p.treeANode = -1,
                      d.p.userDataOnFooter && E.jqGrid("footerData", "set", d.p.userData, !0),
                      j && (d.p.records = q,
                      d.p.lastpage = Math.ceil(q / R)),
                      c || d.updatepager(!1, !0),
                      j) {
                          for (; q > F && s[F]; ) {
                              if (n = s[F],
                              ...
                              void 0 === B && (B = S + F,
                              0 === G.length && g.cell))) {
                                  var cb = $.jgrid.getAccessor(n, g.cell) || n;
                                  B = null != cb && void 0 !== cb[t] ? cb[t] : B,
                                  cb = null
                              }
                              if (n) {
                                  for (B = d.p.idPrefix + B,
                                  p = L,
                                  g.repeatitems && (g.cell && (n = $.jgrid.getAccessor(n, g.cell) || n),
                                  $.isArray(n) && (p = K)),
                                  m = 0; m < p.length; m++)
                                      M[d.p.colModel[m + H + I + J].name] = $.jgrid.getAccessor(n, p[m]);
                                  M[i] = $.jgrid.stripPref(d.p.idPrefix, B),
                                  d.p.grouping && U.call(E, M, F),
                                  d.p.data.push(M),
                                  d.p._index[M[i]] = d.p.data.length - 1,
                                  M = {}
                              }
                          ...
                          d.p.grouping && (d.p.groupingView._locgr = !0,
                          E.jqGrid("groupingRender", W, d.p.colModel.length, d.p.page, R),
                          W = null)
                      }
                  }
              }, G = function() {
                  ...
                  var b, c, e, f, g = d.p.multiSort ? [] : "", h = [], i = !1, j = {}, m = [], n = [];
                  if ($.isArray(d.p.data)) {
                      var o, p, q = d.p.grouping ? d.p.groupingView : !1;
                      if ($.each(d.p.colModel, function() {
                          ...
                          d.p.grouping)
                              for (p = 0,
                              o = q.groupField.length; o > p; p++)
                                  if (this.name === q.groupField[p]) {
                                      var a = this.name;
                      ...
                      if (d.p.ignoreCase && (s = s.ignoreCase()),
                      d.p.search === !0) {
                          var t = d.p.postData.filters;
                          if (t)
                              ...
                              try {
                                  ...
                                  s = r[d.p.postData.searchOper](s)(d.p.postData.searchField, d.p.postData.searchString, j[d.p.postData.searchField])
                              } catch (u) {}
                      } else
                          d.p.treeGrid && "nested" === d.p.treeGridModel && s.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null);
                      if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (o = 0,
                      g = null),
                      d.p.grouping)
                          for (p = 0; o > p; p++)
                              s.orderBy(n[p], q.groupOrder[p], m[p].stype, m[p].srcfmt);
                      d.p.multiSort ? $.each(g, function(a) {
                          s.orderBy(this, h[a], j[this].stype, j[this].srcfmt, j[this].sfunc)
                      }) : g && d.p.sortorder && i && ("DESC" === d.p.sortorder.toUpperCase() ? s.orderBy(d.p.sortname, "d", j[g].stype, j[g].srcfmt, j[g].sfunc) : s.orderBy(d.p.sortname, "a", j[g].stype, j[g].srcfmt, j[g].sfunc));
                      var v = s.select()
                  ...
                  var c, e, f, g, h, i, j, k, l = "", m = d.p.pager ? $.jgrid.jqID(d.p.pager.substr(1)) : "", n = m ? "_" + m : "", o = d.p.toppager ? "_" + d.p.toppager.substr(1) : "";
                  if (f = parseInt(d.p.page, 10) - 1,
                  0 > f && (f = 0),
                  f *= parseInt(d.p.rowNum, 10),
                  h = f + d.p.reccount,
                  d.p.scroll) {
                      var p = $("tbody:first > tr:gt(0)", d.grid.bDiv);
                      f = h - p.length,
                      d.p.reccount = p.length;
                      var q = p.outerHeight() || d.grid.prevRowHeight;
                      if (q) {
                          var s = f * q
                            , t = parseInt(d.p.records, 10) * q;
                          ...
                          0 === d.grid.bDiv.scrollTop && d.p.page > 1 && (d.grid.bDiv.scrollTop = d.p.rowNum * (d.p.page - 1) * q)
                      }
                      d.grid.bDiv.scrollLeft = d.grid.hDiv.scrollLeft
                  }
                  if (l = d.p.pager || "",
                  l += d.p.toppager ? l ? "," + d.p.toppager : d.p.toppager : "") {
                      if (j = $.jgrid.getRegional(d, "formatter.integer"),
                      c = r(d.p.page),
                      e = r(d.p.lastpage),
                      $(".selbox", l)[this.p.useProp ? "prop" : "attr"]("disabled", !1),
                      d.p.pginput === !0 && ($("#input" + n).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input ui-corner-all' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(m) + "'></span>")),
                      d.p.toppager && $("#input_t" + o).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(m) + "_toppager'></span>")),
                      $(".ui-pg-input", l).val(d.p.page),
                      k = d.p.toppager ? "#sp_1" + n + ",#sp_1" + n + "_toppager" : "#sp_1" + n,
                      $(k).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)),
                      d.p.viewrecords)
                          if (0 === d.p.reccount)
                              $(".ui-paging-info", l).html($.jgrid.getRegional(d, "defaults.emptyrecords", d.p.emptyrecords));
                          else {
                              g = f + 1,
                              i = d.p.records,
                              ...
                              var u = $.jgrid.getRegional(d, "defaults.recordtext", d.p.recordtext);
                              $(".ui-paging-info", l).html($.jgrid.template(u, g, h, i))
                          }
                      d.p.pgbuttons === !0 && (0 >= c && (c = e = 0),
                      1 === c || 0 === c ? ($("#first" + n + ", #prev" + n).addClass("ui-state-disabled").removeClass("ui-state-hover"),
                      d.p.toppager && $("#first_t" + o + ", #prev_t" + o).addClass("ui-state-disabled").removeClass("ui-state-hover")) : ($("#first" + n + ", #prev" + n).removeClass("ui-state-disabled"),
                      d.p.toppager && $("#first_t" + o + ", #prev_t" + o).removeClass("ui-state-disabled")),
                      c === e || 0 === c ? ($("#next" + n + ", #last" + n).addClass("ui-state-disabled").removeClass("ui-state-hover"),
                      d.p.toppager && $("#next_t" + o + ", #last_t" + o).addClass("ui-state-disabled").removeClass("ui-state-hover")) : ($("#next" + n + ", #last" + n).removeClass("ui-state-disabled"),
                      d.p.toppager && $("#next_t" + o + ", #last_t" + o).removeClass("ui-state-disabled")))
                  }
                      ...
                      case "script":
                          $.ajax($.extend({
                              ...
                              success: function(c, f, g) {
                                  return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void J() : ("xml" === b ? E(c, o, a > 1, j) : F(c, o, a > 1, j),
                  ...
                  var c, e, f, g, i, j, k, l = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>", m = "", n = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", o = "", p = function(a, b) {
                      var c;
                  ...
                  f = a + "_center",
                  g = a + "_right",
                  $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"),
                  d.p.rowList.length > 0) {
                      o = '<td dir="' + h + '">',
                      o += '<select class="ui-pg-selbox ui-widget-content ui-corner-all" role="listbox" title="' + ($.jgrid.getRegional(d, "defaults.pgrecs", d.p.pgrecs) || "") + '">';
                      var q;
                      for (k = 0; k < d.p.rowList.length; k++)
                          q = d.p.rowList[k].toString().split(":"),
                          1 === q.length && (q[1] = q[0]),
                          o += '<option role="option" value="' + q[0] + '"' + (r(d.p.rowNum, 0) === r(q[0], 0) ? ' selected="selected"' : "") + ">" + q[1] + "</option>";
                      o += "</select></td>"
                  }
                  if ("rtl" === h && (n += o),
                  d.p.pginput === !0 && (m = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"),
                  d.p.pgbuttons === !0) {
                      var s = ["first" + b, "prev" + b, "next" + b, "last" + b];
                      "rtl" === h && s.reverse(),
                      n += "<td id='" + s[0] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "") + "'><span class='ui-icon ui-icon-seek-first'></span></td>",
                      n += "<td id='" + s[1] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "") + "'><span class='ui-icon ui-icon-seek-prev'></span></td>",
                      n += "" !== m ? l + m + l : "",
                      n += "<td id='" + s[2] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "") + "'><span class='ui-icon ui-icon-seek-next'></span></td>",
                      n += "<td id='" + s[3] + "' class='ui-pg-button ui-corner-all' title='" + ($.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || "") + "'><span class='ui-icon ui-icon-seek-end'></span></td>"
                  } else
                      "" !== m && (n += m);
                  "ltr" === h && (n += o),
                  n += "</tr></tbody></table>",
                  d.p.viewrecords === !0 && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + h + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"),
                  $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(n),
                  j = $(".ui-jqgrid").css("font-size") || "11px",
                  $("#gbox_" + $.jgrid.jqID(d.p.id)).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + j + ";visibility:hidden;' ></div>"),
                  i = $(n).clone().appendTo("#testpg").width(),
                  $("#testpg").remove(),
                  i > 0 && ("" !== m && (i += 50),
                  ...
                  $(".ui-pg-selbox", "#" + c).bind("change", function() {
                      return p("records", this) ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1,
                  ...
                  $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b)).click(function() {
                      ...
                      i = !1,
                      a = c - 1),
                      p(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1,
                      e = !0),
                  ...
                  d.p.pginput === !0 && $("#" + c).on("keypress", "input.ui-pg-input", function(a) {
                      ...
                      return 13 === b ? p("user", this) ? ($(this).val(r($(this).val(), 1)),
                  ...
                  $("span.ui-grid-ico-sort", f).addClass("ui-state-disabled"),
                  ...
                  g ? ($("span.s-ico", f).show(),
                  $("span.ui-icon-" + g, f).removeClass("ui-state-disabled"),
                  $(f).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", f).hide();
                  var h = k.indexOf(c);
                  -1 === h ? (k.push(c),
                  l.push(g)) : g ? l[h] = g : (l.splice(h, 1),
                  k.splice(h, 1)),
                  d.p.sortorder = "",
                  d.p.sortname = "";
                  for (var i = 0, j = k.length; j > i; i++)
                      i > 0 && (d.p.sortname += ", "),
                      d.p.sortname += k[i],
                      i !== j - 1 && (d.p.sortname += " " + l[i]);
                  d.p.sortorder = l[j - 1]
                  ...
                  if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                      ...
                      d.p.multiSort)
                          ...
                          var g = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null
                            , h = d.p.frozenColumns ? f : d.grid.headers[b].el;
                      ...
                      d.p.savedRow = []),
                      d.p.scroll) {
                          var i = d.grid.bDiv.scrollLeft;
                          A.call(d, !0, !1),
                          d.grid.hDiv.scrollLeft = i
                      }
                  ...
                  var a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : r(d.p.cellLayout, 0), i = 0, j = r(d.p.scrollOffset, 0), k = !1, l = 0;
                  $.each(d.p.colModel, function() {
                      ...
                      this.widthOrg = b = r(this.width, 0),
                      this.hidden === !1 && (g += b + h,
                      this.fixed ? l += b + h : i++)
                  }),
              ...
              -1 === $.inArray(d.p.multikey, q) && (d.p.multikey = !1),
              d.p.keyName = !1,
              i = 0; i < d.p.colModel.length; i++)
                  p = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {} : d.p.colModel[i].template,
                  d.p.colModel[i] = $.extend(!0, {}, d.p.cmTemplate, p || {}, d.p.colModel[i]),
              ...
              d.p.data.length && (B(),
              C());
              var V, W, X, Y, Z, _, ab, bb, cb, db = "<thead><tr class='ui-jqgrid-labels' role='row'>", eb = "", fb = "";
              ...
              if ("horizontal" === d.p.viewsortcols[1] && (eb = " ui-i-asc",
              fb = " ui-i-desc"),
              V = n ? "class='ui-th-div-ie'" : "",
              cb = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + eb + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + h + "'></span>",
              cb += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + fb + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + h + "'></span></span>",
              d.p.multiSort && d.p.sortname)
                  for (k = d.p.sortname.split(","),
                  i = 0; i < k.length; i++)
                      m = $.trim(k[i]).split(" "),
                      k[i] = $.trim(m[0]),
                      l[i] = m[1] ? $.trim(m[1]) : d.p.sortorder || "asc";
              for (i = 0; i < this.p.colNames.length; i++) {
                  var gb = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
                  db += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + h + "'" + gb + ">",
                  W = d.p.colModel[i].index || d.p.colModel[i].name,
                  db += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + V + ">" + d.p.colNames[i],
                  ...
                  d.p.colModel[i].lso = "",
                  W === d.p.sortname && (d.p.lastsort = i),
                  d.p.multiSort && (m = $.inArray(W, k),
                  -1 !== m && (d.p.colModel[i].lso = l[m])),
                  db += cb + "</div></th>"
              }
              if (db += "</tr></thead>",
              cb = null,
              ...
              this.p.multiselect) {
                  ...
                  $("#cb_" + $.jgrid.jqID(d.p.id), this).bind("click", function() {
                      ...
                      this.checked ? ($(d.rows).each(function(b) {
                          b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass("ui-state-disabled") || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !0),
                          ...
                          $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).addClass("ui-state-highlight"))))
                      }),
                      hb = !0,
                      ib = []) : ($(d.rows).each(function(b) {
                          b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass("ui-state-disabled") || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !1),
                          $(this).removeClass("ui-state-highlight").attr("aria-selected", "false"),
                          ib.push(this.id),
                          a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !1),
                          $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).removeClass("ui-state-highlight"))))
                      }),
                      d.p.selrow = null,
                      hb = !1),
                      $(d).triggerHandler("jqGridSelectAll", [hb ? d.p.selarrrow : ib, hb]),
                      $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, hb ? d.p.selarrrow : ib, hb)
                  })
              }
              if (d.p.autowidth === !0) {
                  var jb = $(o).innerWidth();
                  d.p.width = jb > 0 ? jb : "nw"
              }
              P(),
              $(o).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"),
              d.p.scrollPopUp && $(o).append("<div class='loading ui-scroll-popup ui-widget-content' id='scroll_g" + d.p.id + "'></div>"),
              $(j).css("width", e.width + "px"),
              db = $("thead:first", d).get(0);
              var kb = "";
              d.p.footerrow && (kb += "<table role='presentation' style='width:" + d.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + h + "'>");
              var lb = $("tr:first", db)
                , mb = "<tr class='jqgfirstrow' role='row' style='height:auto'>";
              if (d.p.disableClick = !1,
              $("th", lb).each(function(a) {
                  X = d.p.colModel[a].width,
                  void 0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0),
                  d.p.colModel[a].resizable ? (Y = document.createElement("span"),
                  $(Y).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"),
                  $(this).addClass(d.p.resizeclass)) : Y = "",
                  $(this).css("width", X + "px").prepend(Y),
                  Y = null;
                  var b = "";
                  d.p.colModel[a].hidden && ($(this).css("display", "none"),
                  b = "display:none;"),
                  mb += "<td role='gridcell' style='height:0px;width:" + X + "px;" + b + "'></td>",
                  e.headers[a] = {
                      width: X,
                      el: this
                  },
                  Z = d.p.colModel[a].sortable,
                  "boolean" != typeof Z && (d.p.colModel[a].sortable = !0,
                  Z = !0);
                  var c = d.p.colModel[a].name;
                  "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"),
                  Z && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                  d.p.colModel[a].lso && $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(),
                  $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                  a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(),
                  $("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled"))),
                  d.p.footerrow && (kb += "<td role='gridcell' " + s(a, 0, "", null, "", !1) + ">&#160;</td>")
              }).mousedown(function(a) {
                  if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                      var b = S(this);
                      return d.p.forceFit === !0 && (d.p.nv = Q(b)),
                      e.dragStart(b, a, R(b)),
                      !1
                  }
              }).click(function(a) {
                  ...
                  if (1 === f.length) {
                      ...
                      c = f.attr("sort")),
                      null != g && O($("div", this)[0].id, g, b, c, this),
                      !1
                  }
              }),
              d.p.sortable && $.fn.sortable)
                  try {
                      $(d).jqGrid("sortableColumns", lb)
                  } catch (nb) {}
              d.p.footerrow && (kb += "</tr></tbody></table>"),
              mb += "</tr>",
              bb = document.createElement("tbody"),
              this.appendChild(bb),
              $(this).addClass("ui-jqgrid-btable").append(mb),
              mb = null;
              var ob = $("<table class='ui-jqgrid-htable' style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(db)
                , pb = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1
                , qb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
              db = null,
              e.hDiv = document.createElement("div"),
              $(e.hDiv).css({
                  width: e.width + "px"
              }).addClass("ui-state-default ui-jqgrid-hdiv").append(qb),
              $(qb).append(ob),
              ob = null,
              pb && $(e.hDiv).hide(),
              ...
              $(d.p.pager).css({
                  width: e.width + "px"
              }).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(o),
              pb && $(d.p.pager).hide(),
              M(d.p.pager, "")),
              d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function(a) {
                  ab = $(a.target).closest("tr.jqgrow"),
                  "ui-subgrid" !== $(ab).attr("class") && $(ab).addClass("ui-state-hover")
              }).bind("mouseout", function(a) {
                  ab = $(a.target).closest("tr.jqgrow"),
                  $(ab).removeClass("ui-state-hover")
              });
              var rb, sb, tb;
              $(d).before(e.hDiv).click(function(a) {
                  if (_ = a.target,
                  ab = $(_, d.rows).closest("tr.jqgrow"),
                  0 === $(ab).length || ab[0].className.indexOf("ui-state-disabled") > -1 || ($(_, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
                      return this;
                  var b = $(_).hasClass("cbox")
                    , c = $(d).triggerHandler("jqGridBeforeSelectRow", [ab[0].id, a]);
                  if (c = c === !1 || "stop" === c ? !1 : !0,
                  $.isFunction(d.p.beforeSelectRow)) {
                      var e = d.p.beforeSelectRow.call(d, ab[0].id, a);
                      (e === !1 || "stop" === e) && (c = !1)
                  }
                  if ("A" !== _.tagName && ("INPUT" !== _.tagName && "TEXTAREA" !== _.tagName && "OPTION" !== _.tagName && "SELECT" !== _.tagName || b)) {
                      if (rb = ab[0].id,
                      _ = $(_).closest("tr.jqgrow>td"),
                      _.length > 0 && (sb = $.jgrid.getCellIndex(_),
                      tb = $(_).closest("td,th").html(),
                      $(d).triggerHandler("jqGridCellSelect", [rb, sb, tb, a]),
                      $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, rb, sb, tb, a)),
                      d.p.cellEdit === !0)
                          if (d.p.multiselect && b && c)
                              $(d).jqGrid("setSelection", rb, !0, a);
                          else if (_.length > 0) {
                              rb = ab[0].rowIndex;
                              try {
                                  $(d).jqGrid("editCell", rb, sb, !0)
                              } catch (f) {}
                          }
                      if (c)
                          if (d.p.multikey)
                              a[d.p.multikey] ? $(d).jqGrid("setSelection", rb, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + rb).is(":checked"),
                              $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + rb)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                              ...
                              if (b)
                                  ...
                                  $(d.p.selarrrow).each(function(a, b) {
                                      ...
                                      c && $(c).removeClass("ui-state-highlight"),
                                      $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", !1),
                                      g && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g)).removeClass("ui-state-highlight"),
                  ...
                  d.p.data.length && (B(),
                  C())) : d.p.treeGrid || (d.p.selrow = null,
                  d.p.multiselect && (d.p.selarrrow = [],
                  L(!1)),
                  d.p.savedRow = []),
                  d.p.scroll && A.call(d, !0, !1),
                  b.page) {
                      var c = b.page;
                  ...
                  0 !== $(ab).length) {
                      rb = ab[0].rowIndex,
                      sb = $.jgrid.getCellIndex(_);
                      var b = $(d).triggerHandler("jqGridDblClickRow", [$(ab).attr("id"), rb, sb, a]);
                      return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(ab).attr("id"), rb, sb, a),
                      null != b) ? b : void 0
                  }
                  ...
                  ab = $(_, d.rows).closest("tr.jqgrow"),
                  0 !== $(ab).length) {
                      d.p.multiselect || $(d).jqGrid("setSelection", ab[0].id, !0, a),
                      rb = ab[0].rowIndex,
                      sb = $.jgrid.getCellIndex(_);
                      var b = $(d).triggerHandler("jqGridRightClickRow", [$(ab).attr("id"), rb, sb, a]);
                      return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(ab).attr("id"), rb, sb, a),
                      null != b) ? b : void 0
                  }
              }),
              e.bDiv = document.createElement("div"),
              n && "auto" === String(d.p.height).toLowerCase() && (d.p.height = "100%"),
              ...
              var ub = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                  ub.addClass("ui-state-hover")
              }, function() {
                  ub.removeClass("ui-state-hover")
              }).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
              if ($(e.cDiv).append(ub).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " ui-widget-header ui-corner-top ui-helper-clearfix"),
              $(e.cDiv).insertBefore(e.hDiv),
              d.p.toolbar[0] && (e.uDiv = document.createElement("div"),
              ...
              $(e.uDiv).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id).insertBefore(e.hDiv),
              $(e.ubDiv).addClass("ui-userdata ui-state-default").attr("id", "tb_" + this.id).insertAfter(e.hDiv),
              pb && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id),
              pb && $(e.uDiv).hide()),
              d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager",
              e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0],
              d.p.toppager = "#" + d.p.toppager,
              $(e.topDiv).addClass("ui-state-default ui-jqgrid-toppager").width(e.width).insertBefore(e.hDiv),
              M(d.p.toppager, "_t")),
              d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0],
              qb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"),
              $(e.sDiv).append(qb).width(e.width).insertAfter(e.hDiv),
              $(qb).append(kb),
              e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells,
              d.p.rownumbers && (e.footers[0].className = "ui-state-default jqgrid-rownum"),
              pb && $(e.sDiv).hide()),
              qb = null,
              d.p.caption) {
                  var vb = d.p.datatype;
                  d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                      var b, c = $.isFunction(d.p.onHeaderClick), f = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this;
                      ...
                      "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                          b--,
                          0 === b && ($("span", g).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),
                          ...
                          c && (pb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                      }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
                          b--,
                          0 === b && ($("span", g).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),
                          pb && (d.p.datatype = vb,
                          K(),
                          pb = !1),
                  ...
                  pb && (d.p.datatype = "local",
                  $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
              } else
                  $(e.cDiv).hide(),
                  d.p.toppager || $(e.hDiv).addClass("ui-corner-top");
  ...
  $.jgrid.extend({
      ...
      setSelection: function(a, b, c) {
          return this.each(function() {
              ...
              !f || !f.className || f.className.indexOf("ui-state-disabled") > -1 || (l.p.scrollrows === !0 && (g = $(l).jqGrid("getGridRowById", a).rowIndex,
              g >= 0 && d(g)),
              l.p.frozenColumns === !0 && (j = l.p.id + "_frozen"),
              l.p.multiselect ? (l.setHeadCheckBox(!1),
              l.p.selrow = f.id,
              h = $.inArray(l.p.selrow, l.p.selarrrow),
              -1 === h ? ("ui-subgrid" !== f.className && $(f).addClass("ui-state-highlight").attr("aria-selected", "true"),
              e = !0,
              l.p.selarrrow.push(l.p.selrow)) : ("ui-subgrid" !== f.className && $(f).removeClass("ui-state-highlight").attr("aria-selected", "false"),
              e = !1,
              ...
              j && (-1 === h ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass("ui-state-highlight") : $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).removeClass("ui-state-highlight"),
              ...
              k && $(k).removeClass("ui-state-highlight").attr({
                  "aria-selected": "false",
                  tabindex: "-1"
              }),
              ...
              j && ($("#" + $.jgrid.jqID(l.p.selrow), "#" + $.jgrid.jqID(j)).removeClass("ui-state-highlight"),
              $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass("ui-state-highlight")),
              e = !0) : e = !1,
              l.p.selrow = f.id,
              b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]),
      ...
      resetSelection: function(a) {
          return this.each(function() {
              ...
              void 0 !== a) {
                  ...
                  $("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(b)).removeClass("ui-state-highlight").attr("aria-selected", "false"),
                  c && $("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass("ui-state-highlight"),
                  d.p.multiselect) {
                      ...
                      d.setHeadCheckBox(!1);
                      var e = $.inArray($.jgrid.jqID(b), d.p.selarrrow);
                  ...
                  d.setHeadCheckBox(!1),
                  d.p.selarrrow = [],
                  d.p.selrow = null) : d.p.selrow && ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(d.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"),
                  c && $("#" + $.jgrid.jqID(d.p.selrow), "#" + $.jgrid.jqID(c)).removeClass("ui-state-highlight"),
                  d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, d.p.selrow),
                  d.p.selrow = null);
              d.p.cellEdit === !0 && parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && ($("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell ui-state-highlight"),
              $(d.rows[d.p.iRow]).removeClass("selected-row ui-state-hover")),
              d.p.savedRow = []
          })
      },
      ...
      addRowData: function(a, b, c, d) {
          ...
          this.each(function() {
              ...
              for (var w = 0, x = "", y = {}, z = $.isFunction(u.p.afterInsertRow) ? !0 : !1; v > w; ) {
                  ...
                  for (r = a,
                  a = u.p.idPrefix + a,
                  i && (t = u.formatCol(0, 1, "", null, a, !0),
                  f[f.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + t + ">0</td>"),
                  g && (l = '<input role="checkbox" type="checkbox" id="jqg_' + u.p.id + "_" + a + '" class="cbox"/>',
                  t = u.formatCol(i, 1, "", null, a, !0),
                  f[f.length] = '<td role="gridcell" ' + t + ">" + l + "</td>"),
                  h && (f[f.length] = $(u).jqGrid("addSubGridCell", g + i, 1)),
                  k = g + h + i; k < u.p.colModel.length; k++)
                      q = u.p.colModel[k],
                      e = q.name,
                      y[e] = p[e],
                      ...
                      f[f.length] = '<td role="gridcell" ' + t + ">" + l + "</td>";
                  if (f.unshift(u.constructTr(a, !1, x, y, p, !1)),
                  f[f.length] = "</tr>",
                  0 === u.rows.length)
                      $("table:first", u.grid.bDiv).append(f.join(""));
                  else
                      switch (c) {
                      case "last":
                      ...
                      case "after":
                          ...
                          j && ($(u.rows[j.rowIndex + 1]).hasClass("ui-subgrid") ? $(u.rows[j.rowIndex + 1]).after(f) : $(j).after(f.join("")),
                          j = j.rowIndex + 1);
                          break;
                      case "before":
                          j = $(u).jqGrid("getGridRowById", d),
                  ...
                  w++,
                  "local" === u.p.datatype && (y[u.p.localReader.id] = r,
                  u.p._index[r] = u.p.data.length,
                  u.p.data.push(y),
                  y = {})
              }
              u.p.altRows !== !0 || m || ("last" === c ? (u.rows.length - 1) % 2 === 0 && $(u.rows[u.rows.length - 1]).addClass(o) : $(u.rows).each(function(a) {
      ...
      setGridState: function(a) {
          return this.each(function() {
              if (this.grid) {
                  ...
                  $(".ui-jqgrid-titlebar-close span", b.grid.cDiv).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s"),
                  ...
                  $(".ui-jqgrid-titlebar-close span", b.grid.cDiv).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n"),
              ...
              if (this.grid) {
                  ...
                  if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                      ...
                      a.p.multiselect && c++; d > c && b[c].frozen === !0; )
                          ...
                          c++;
                      if (e >= 0 && f) {
                          var g = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0
                            , h = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                          a.p.toppager && (g += $(a.grid.topDiv).outerHeight()),
                          a.p.toolbar[0] === !0 && "bottom" !== a.p.toolbar[1] && (g += $(a.grid.uDiv).outerHeight()),
                          a.grid.fhDiv = $('<div style="position:absolute;left:0px;top:' + g + "px;height:" + h + 'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>'),
                          a.grid.fbDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(g, 10) + parseInt(h, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'),
                          $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);
                          var i = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                          if (a.p.groupHeader) {
                              ...
                              $("tr.jqg-second-row-header th", i).each(function() {
                                  return j = parseInt($(this).attr("colspan"), 10),
                                  k = parseInt($(this).attr("rowspan"), 10),
                                  k && (l++,
                                  m++),
                                  j && (l += j,
                                  m++),
                              ...
                              l !== e && (m = e),
                              $("tr.jqg-second-row-header", i).each(function() {
                                  $("th:gt(" + m + ")", this).remove()
                              })
                          } else
                              $("tr", i).each(function() {
                          ...
                          if ($(i).width(1),
                          $(a.grid.fhDiv).append(i).mousemove(function(b) {
                              return a.grid.resizing ? (a.grid.dragMove(b),
                              !1) : void 0
                          }),
                          a.p.footerrow) {
                              var n = $(".ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                              a.grid.fsDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(g, 10) + parseInt(h, 10) + parseInt(n, 10) + 1) + 'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),
                              $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fsDiv);
                              var o = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                              $("tr", o).each(function() {
                                  $("td:gt(" + e + ")", this).remove()
                              }),
                              $(o).width(1),
                              $(a.grid.fsDiv).append(o)
                          }
                          ...
                          $(a).bind("jqGridAfterGridComplete.setFrozenColumns", function() {
                              ...
                              a.p.hoverrows === !0 && ($("tr.jqgrow", b).hover(function() {
                                  $(this).addClass("ui-state-hover"),
                                  $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).addClass("ui-state-hover")
                              }, function() {
                                  $(this).removeClass("ui-state-hover"),
                                  $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id)).removeClass("ui-state-hover")
                              }),
                              $("tr.jqgrow", "#" + $.jgrid.jqID(a.p.id)).hover(function() {
                                  $(this).addClass("ui-state-hover"),
                                  $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").addClass("ui-state-hover")
                              }, function() {
                                  $(this).removeClass("ui-state-hover"),
                                  $("#" + $.jgrid.jqID(this.id), "#" + $.jgrid.jqID(a.p.id) + "_frozen").removeClass("ui-state-hover")
                              })),
                              b = null
                          }),
              ...
              if (this.grid && this.p.frozenColumns === !0) {
                  ...
                  a.p.hoverrows === !0) {
                      ...
                      $("#" + $.jgrid.jqID(a.p.id)).bind("mouseover", function(a) {
                          b = $(a.target).closest("tr.jqgrow"),
                          "ui-subgrid" !== $(b).attr("class") && $(b).addClass("ui-state-hover")
                      }).bind("mouseout", function(a) {
                          b = $(a.target).closest("tr.jqgrow"),
              ...
              if (h.grid && h.p.cellEdit === !0) {
                  ...
                  "subgrid" !== d && "cb" !== d && "rn" !== d) {
                      ...
                      g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))
                          parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && ($("td:eq(" + h.p.iCol + ")", h.rows[h.p.iRow]).removeClass("edit-cell ui-state-highlight"),
                          $(h.rows[h.p.iRow]).removeClass("selected-row ui-state-hover")),
                          f.addClass("edit-cell ui-state-highlight"),
                          $(h.rows[a]).addClass("selected-row ui-state-hover"),
                          ...
                          $.isFunction(h.p.formatCell)) {
                              var j = h.p.formatCell.call(h, h.rows[a].id, d, e, a, b);
                              void 0 !== j && (e = j)
                          }
                          ...
                          var k = $.extend({}, g.editoptions || {}, {
                              id: a + "_" + d,
                              name: d,
                              rowId: h.rows[a].id,
                              oper: "edit"
                          })
                            , l = $.jgrid.createEl.call(h, g.edittype, k, e, !0, $.extend({}, $.jgrid.ajaxOptions, h.p.ajaxSelectOptions || {}));
                          $(f).html("").append(l).attr("tabindex", "0"),
                          $.jgrid.bindEv.call(h, l, k),
                          window.setTimeout(function() {
                              $(l).focus()
                          }, 1),
                  ...
                  null !== c) {
                      ...
                      case "custom":
                          try {
                              ...
                              "e2" === p ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.novalue, f.bClose) : $.jgrid.info_dialog(e.errcap, p.message, f.bClose)
                          }
                      }
  ...
  $.extend($.jgrid, {
      ...
      hideModal: function(a, b) {
          ...
          if (b.formprop && c && b.form) {
              ...
              var f, g;
              "edit" === b.form ? (f = "#" + $.jgrid.jqID("FrmGrid_" + b.gb.substr(6)),
              g = "formProp") : "view" === b.form && (f = "#" + $.jgrid.jqID("ViewGrid_" + b.gb.substr(6)),
              g = "viewProp"),
              $(c).data(g, {
      ...
      createModal: function(a, b, c, d, e, f, g) {
          ...
          var h, i = document.createElement("div"), j = this;
          g = $.extend({}, g || {}),
          h = "rtl" === $(c.gbox).attr("dir") ? !0 : !1,
          ...
          k.id = a.modalhead,
          $(k).append("<span class='ui-jqdialog-title'>" + c.caption + "</span>");
          var l = $("<a class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(function() {
          ...
          $(k).append(l),
          h ? (i.dir = "rtl",
          $(".ui-jqdialog-title", k).css("float", "right"),
          $(".ui-jqdialog-titlebar-close", k).css("left", "0.3em")) : (i.dir = "ltr",
          $(".ui-jqdialog-title", k).css("float", "left"),
          $(".ui-jqdialog-titlebar-close", k).css("right", "0.3em"));
          var m = document.createElement("div");
          $(m).addClass("ui-jqdialog-content ui-widget-content").attr("id", a.modalcontent),
          $(m).append(b),
          i.appendChild(m),
          $(i).prepend(k),
          f === !0 ? $("body").append(i) : "string" == typeof f ? $(f).append(i) : $(i).insertBefore(d),
          $(i).css(g),
          ...
          if ($.fn.jqm && c.jqModal === !0) {
              ...
              (0 !== c.left || 0 !== c.top) && (n.left = c.left,
              n.top = c.top + "px");
          if ($("a.ui-jqdialog-titlebar-close", k).click(function() {
              var b = $("#" + $.jgrid.jqID(a.themodal)).data("onClose") || c.onClose
                , d = $("#" + $.jgrid.jqID(a.themodal)).data("gbox") || c.gbox;
              return j.hideModal("#" + $.jgrid.jqID(a.themodal), {
                  gb: d,
                  jqm: c.jqModal,
                  onClose: b,
          ...
          !c.zIndex) {
              var p = $(d).parents("*[role=dialog]").filter(":first").css("z-index");
              c.zIndex = p ? parseInt(p, 10) + 2 : 950
          }
          var q = 0;
          if (h && n.left && !f && (q = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8,
          n.left = parseInt(n.left, 10) + parseInt(q, 10)),
          n.left && (n.left += "px"),
          $(i).css($.extend({
          ...
          c.drag)
              if ($(k).css("cursor", "move"),
              $.fn.jqDrag)
                  $(i).jqDrag(k);
              else
                  try {
                      $(i).draggable({
                          handle: $("#" + $.jgrid.jqID(k.id))
                      })
                  } catch (r) {}
          if (c.resize)
              if ($.fn.jqResize)
                  $(i).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"),
          ...
          c.closeOnEscape === !0 && $(i).keydown(function(b) {
              if (27 === b.which) {
                  var d = $("#" + $.jgrid.jqID(a.themodal)).data("onClose") || c.onClose;
                  j.hideModal("#" + $.jgrid.jqID(a.themodal), {
                      gb: c.gbox,
                      jqm: c.jqModal,
                      onClose: d,
                      removemodal: c.removemodal || !1,
      ...
      viewModal: function(a, b) {
          ...
          $.fn.jqm && b.jqm === !0)
              ...
              "" !== b.gbox && ($(".jqgrid-overlay:first", b.gbox).show(),
              $(a).data("gbox", b.gbox)),
              $(a).show().attr("aria-hidden", "false");
              try {
                  $(":input:visible", a)[0].focus()
              } catch (c) {}
          }
      },
      info_dialog: function(a, b, c, d) {
          ...
          if (e.buttons.length > 0)
              for (h = 0; h < e.buttons.length; h++)
                  void 0 === e.buttons[h].id && (e.buttons[h].id = "info_button_" + h),
                  i += "<a id='" + e.buttons[h].id + "' class='fm-button ui-state-default ui-corner-all'>" + e.buttons[h].text + "</a>";
          var j = isNaN(e.dataheight) ? e.dataheight : e.dataheight + "px"
            , k = "text-align:" + e.align + ";"
            , l = "<div id='info_id'>";
          l += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + j + ";" + k + "'>" + b + "</div>",
          l += c ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button ui-state-default ui-corner-all'>" + c + "</a>" + i + "</div>" : "" !== i ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + i + "</div>" : "",
          l += "</div>";
          try {
          ...
          case "select":
              ...
              null != b.dataUrl) {
                  ...
                  $.ajax($.extend({
                      ...
                      success: function(a) {
                          var b, c, d = [], e = this.elem, c = this.vl, g = $.extend({}, this.options), i = g.multiple === !0, j = g.cacheUrlData === !0, k = "", l = $.isFunction(g.buildSelect) ? g.buildSelect.call(h, a) : a;
                          "string" == typeof l && (l = $($.trim(l)).html()),
                          l && ($(e).append(l),
                          f(e, g, n ? ["postData"] : void 0),
                          ...
                          setTimeout(function() {
                              if ($("option", e).each(function(a) {
                                  b = $(this).text(),
                                  c = $(this).val() || b,
                                  j && (k += (0 !== a ? ";" : "") + c + ":" + b),
                                  0 === a && e.multiple && (this.selected = !1),
                                  $(this).attr("role", "option"),
                                  ($.inArray($.trim(b), d) > -1 || $.inArray($.trim(c), d) > -1) && (this.selected = "selected")
                              }),
                              j)
                                  if ("edit" === g.oper)
                              ...
                              $(h).triggerHandler("jqGridAddEditAfterSelectUrlComplete", [e])
                          }, 0))
                      }
                  }, e || {}))
              } else if (b.value) {
                  ...
                  var q, r, s, t = void 0 === b.separator ? ":" : b.separator, u = void 0 === b.delimiter ? ";" : b.delimiter;
                  if ("string" == typeof b.value)
                      for (q = b.value.split(u),
                      p = 0; p < q.length; p++)
                          r = q[p].split(t),
                      ...
                      for (var v = b.value, p = 0; p < v.length; p++)
                          if (2 === v[p].length) {
                              var w = v[p][0]
                                , x = v[p][1];
                              s = document.createElement("option"),
                              ...
                              s.innerHTML = x,
                              g.appendChild(s),
                              k || $.trim(w) !== $.trim(c) && $.trim(x) !== $.trim(c) || (s.selected = "selected"),
                              k && ($.inArray($.trim(x), l) > -1 || $.inArray($.trim(w), l) > -1) && (s.selected = "selected")
                          }
                  } else if ("object" == typeof b.value) {
                      var w, v = b.value;
                      for (w in v)
                          v.hasOwnProperty(w) && (s = document.createElement("option"),
                          s.setAttribute("role", "option"),
                          s.value = w,
                          s.innerHTML = v[w],
                          g.appendChild(s),
                          k || $.trim(w) !== $.trim(c) && $.trim(v[w]) !== $.trim(c) || (s.selected = "selected"),
                          k && ($.inArray($.trim(v[w]), l) > -1 || $.inArray($.trim(w), l) > -1) && (s.selected = "selected"))
                  }
                  f(g, b, ["value"])
              }
              break;
          ...
          case "custom":
              ...
              try {
                  if (!$.isFunction(b.custom_element))
                      throw "e1";
                  var z = b.custom_element.call(h, c, b);
                  if (!z)
                      throw "e2";
                  z = $(z).addClass("customelement").attr({
                      id: b.id,
                      name: b.name
                  }),
                  $(g).empty().append(z)
              } catch (o) {
                  var A = $.jgrid.getRegional(h, "errors")
                    , B = $.jgrid.getRegional(h, "edit");
                  "e1" === o && $.jgrid.info_dialog(A.errcap, "function 'custom_element' " + B.msg.nodefined, B.bClose),
                  "e2" === o ? $.jgrid.info_dialog(A.errcap, "function 'custom_element' " + B.msg.novalue, B.bClose) : $.jgrid.info_dialog(A.errcap, "string" == typeof o ? o : o.message, B.bClose)
              }
          }
          return g
      },
          ...
          if (!this.filter) {
              ...
              c) {
                  ...
                  this.createTableForGroup = function(a, b) {
                      var c, e = this, f = $("<table class='group ui-widget ui-widget-content ui-search-table' style='border:0px none;'><tbody></tbody></table>"), g = "left";
                      "rtl" === this.p.direction && (g = "right",
                      f.attr("dir", "rtl")),
                      null === b && f.append("<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='" + g + "'></th></tr>");
                      var h = $("<tr></tr>");
                      f.append(h);
                      var i = $("<th colspan='5' align='" + g + "'></th>");
                      if (h.append(i),
                      this.p.ruleButtons === !0) {
                          var j = $("<select class='opsel ui-widget-content ui-corner-all'></select>");
                          i.append(j);
                          var k, l = "";
                          for (c = 0; c < d.groupOps.length; c++)
                              k = a.groupOp === e.p.groupOps[c].op ? " selected='selected'" : "",
                              l += "<option value='" + e.p.groupOps[c].op + "'" + k + ">" + e.p.groupOps[c].text + "</option>";
                          j.append(l).bind("change", function() {
                              a.groupOp = $(j).val(),
                              e.onchange()
                          })
                      }
                      var m = "<span></span>";
                      if (this.p.groupButton && (m = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group ui-widget-content ui-corner-all'/>"),
                      ...
                      i.append(m),
                      this.p.ruleButtons === !0) {
                          var n, o = $("<input type='button' value='+' title='Add rule' class='add-rule ui-add ui-widget-content ui-corner-all'/>");
                          o.bind("click", function() {
                              ...
                              var g;
                              return g = n.searchoptions.sopt ? n.searchoptions.sopt : e.p.sopt ? e.p.sopt : -1 !== $.inArray(n.searchtype, e.p.strarr) ? e.p.stropts : e.p.numopts,
                              a.rules.push({
                                  field: n.name,
                                  op: g[0],
                                  data: ""
                      ...
                      if (null !== b) {
                          var p = $("<input type='button' value='-' title='Delete group' class='delete-group ui-widget-content ui-corner-all'/>");
                          i.append(p),
                      ...
                      if (void 0 !== a.groups)
                          for (c = 0; c < a.groups.length; c++) {
                              var q = $("<tr></tr>");
                              f.append(q);
                              var r = $("<td class='first'></td>");
                              q.append(r);
                              var s = $("<td colspan='4'></td>");
                              s.append(this.createTableForGroup(a.groups[c], a)),
                              q.append(s)
                          }
                  ...
                  this.createTableRowForRule = function(a, b) {
                      var c, g, h, i, j, k = this, l = f(), m = $("<tr></tr>"), n = "";
                      m.append("<td class='first'></td>");
                      var o = $("<td class='columns'></td>");
                      m.append(o);
                      var p, q = $("<select class='ui-widget-content ui-corner-all'></select>"), r = [];
                      o.append(q),
                      q.bind("change", function() {
                          for (a.field = $(q).val(),
                          h = $(this).parents("tr:first"),
                          $(".data", h).empty(),
                          c = 0; c < k.p.columns.length; c++)
                              if (k.p.columns[c].name === a.field) {
                                  i = k.p.columns[c];
                                  break
                              }
                          if (i) {
                              i.searchoptions.id = $.jgrid.randId(),
                              i.searchoptions.name = a.field,
                              i.searchoptions.oper = "filter",
                              e && "text" === i.inputtype && (i.searchoptions.size || (i.searchoptions.size = 10));
                              var b = $.jgrid.createEl.call(l, i.inputtype, i.searchoptions, "", !0, k.p.ajaxSelectOptions || {}, !0);
                              $(b).addClass("input-elm ui-widget-content ui-corner-all"),
                              g = i.searchoptions.sopt ? i.searchoptions.sopt : k.p.sopt ? k.p.sopt : -1 !== $.inArray(i.searchtype, k.p.strarr) ? k.p.stropts : k.p.numopts;
                              var d = ""
                                , f = 0;
                              for (r = [],
                              $.each(k.p.ops, function() {
                                  r.push(this.oper)
                              }),
                              c = 0; c < g.length; c++)
                                  p = $.inArray(g[c], r),
                                  -1 !== p && (0 === f && (a.op = k.p.ops[p].oper),
                                  d += "<option value='" + k.p.ops[p].oper + "'>" + k.p.ops[p].text + "</option>",
                                  f++);
                              if ($(".selectopts", h).empty().append(d),
                              $(".selectopts", h)[0].selectedIndex = 0,
                              $.jgrid.msie && $.jgrid.msiever() < 9) {
                                  var j = parseInt($("select.selectopts", h)[0].offsetWidth, 10) + 1;
                                  $(".selectopts", h).width(j),
                                  $(".selectopts", h).css("width", "auto")
                              }
                              $(".data", h).append(b),
                              $.jgrid.bindEv.call(l, b, i.searchoptions),
                              $(".input-elm", h).bind("change", function(b) {
                                  var c = b.target;
                                  a.data = "SPAN" === c.nodeName.toUpperCase() && i.searchoptions && $.isFunction(i.searchoptions.custom_value) ? i.searchoptions.custom_value.call(l, $(c).children(".customelement:first"), "get") : c.value,
                                  k.onchange()
                              }),
                              setTimeout(function() {
                                  a.data = $(b).val(),
                      ...
                      var s = 0;
                      for (c = 0; c < k.p.columns.length; c++) {
                          var t = void 0 === k.p.columns[c].search ? !0 : k.p.columns[c].search
                            , u = k.p.columns[c].hidden === !0
                            , v = k.p.columns[c].searchoptions.searchhidden === !0;
                          (v && t || t && !u) && (j = "",
                          a.field === k.p.columns[c].name && (j = " selected='selected'",
                          s = c),
                          n += "<option value='" + k.p.columns[c].name + "'" + j + ">" + k.p.columns[c].label + "</option>")
                      }
                      q.append(n);
                      var w = $("<td class='operators'></td>");
                      m.append(w),
                      i = d.columns[s],
                      i.searchoptions.id = $.jgrid.randId(),
                      e && "text" === i.inputtype && (i.searchoptions.size || (i.searchoptions.size = 10)),
                      i.searchoptions.name = a.field,
                      i.searchoptions.oper = "filter";
                      var x = $.jgrid.createEl.call(l, i.inputtype, i.searchoptions, a.data, !0, k.p.ajaxSelectOptions || {}, !0);
                      ("nu" === a.op || "nn" === a.op) && ($(x).attr("readonly", "true"),
                      $(x).attr("disabled", "true"));
                      var y = $("<select class='selectopts ui-widget-content ui-corner-all'></select>");
                      for (w.append(y),
                      ...
                      c = 0; c < g.length; c++)
                          p = $.inArray(g[c], r),
                          -1 !== p && (j = a.op === k.p.ops[p].oper ? " selected='selected'" : "",
                          n += "<option value='" + k.p.ops[p].oper + "'" + j + ">" + k.p.ops[p].text + "</option>");
                      y.append(n);
                      var z = $("<td class='data'></td>");
                      m.append(z),
                      z.append(x),
                      $.jgrid.bindEv.call(l, x, i.searchoptions),
                      $(x).addClass("input-elm ui-widget-content ui-corner-all").bind("change", function() {
                          a.data = "custom" === i.inputtype ? i.searchoptions.custom_value.call(l, $(this).children(".customelement:first"), "get") : $(this).val(),
                          k.onchange()
                      });
                      var A = $("<td></td>");
                      if (m.append(A),
                      this.p.ruleButtons === !0) {
                          var B = $("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del ui-widget-content ui-corner-all'/>");
                          A.append(B),
                  ...
                  this.getStringForRule = function(a) {
                      var b, c, e, f, h = "", i = "", j = ["int", "integer", "float", "number", "currency"];
                      for (b = 0; b < this.p.ops.length; b++)
                          if (this.p.ops[b].oper === a.op) {
                              h = this.p.operands.hasOwnProperty(a.op) ? this.p.operands[a.op] : "",
                              i = this.p.ops[b].oper;
                              break
                          }
                      ...
                      ("cn" === i || "nc" === i) && (f = "%" + f + "%"),
                      ("in" === i || "ni" === i) && (f = " (" + f + ")"),
                      d.errorcheck && g(a.data, c),
                      e = -1 !== $.inArray(c.searchtype, j) || "nn" === i || "nu" === i ? a.field + " " + h + " " + f : a.field + " " + h + ' "' + f + '"')
                  }
                  ,
          ...
          this.each(function() {
              ...
              if (!c.p.filterToolbar) {
                  ...
                  var d, e = function() {
                      ...
                      d = parseInt(d, 10),
                      f = parseInt(f, 10) + 18;
                      for (var g, h, i = $(".ui-jqgrid-view").css("font-size") || "11px", j = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:' + i + ";left:" + d + "px;top:" + f + 'px;">', k = $(b).attr("soper"), l = [], m = 0, n = $(b).attr("colname"), o = c.p.colModel.length; o > m && c.p.colModel[m].name !== n; )
                          m++;
                      var p = c.p.colModel[m]
                        , q = $.extend({}, p.searchoptions);
                      for (q.sopt || (q.sopt = [],
                      q.sopt[0] = "select" === p.stype ? "eq" : a.defaultSearch),
                      $.each(a.odata, function() {
                          l.push(this.oper)
                      }),
                      m = 0; m < q.sopt.length; m++)
                          h = $.inArray(q.sopt[m], l),
                          -1 !== h && (g = k === a.odata[h].oper ? "ui-state-highlight" : "",
                          j += '<li class="ui-menu-item ' + g + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[h].oper + '" oper="' + a.operands[a.odata[h].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' + a.operands[a.odata[h].oper] + "</td><td>" + a.odata[h].text + "</td></tr></table></a></li>");
                      j += "</ul>",
                      $("body").append(j),
                      ...
                      $("#sopt_menu > li > a").hover(function() {
                          ...
                          var d = $(this).attr("value")
                            , f = $(this).attr("oper");
                          if ($(c).triggerHandler("jqGridToolbarSelectOper", [d, f, b]),
                          $("#sopt_menu").hide(),
                          $(b).text(f).attr("soper", d),
                          a.autosearch === !0) {
                              var g = $(b).parent().next().children()[0];
                              ($(g).val() || "nu" === d || "nn" === d) && e()
                          }
                      })
                  }, i = $("<tr class='ui-search-toolbar' role='row'></tr>");
                  $.each(c.p.colModel, function(b) {
                      var f, g, h, j, k, l, m, n = this, o = "", p = "=", q = $("<th role='columnheader' class='ui-state-default ui-th-" + c.p.direction + "' id='gsh_" + c.p.id + "_" + n.name + "' ></th>"), r = $("<div></div>"), s = $("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper' headers=''></td><td class='ui-search-input' headers=''></td><td class='ui-search-clear' headers=''></td></tr></table>");
                      if (this.hidden === !0 && $(q).css("display", "none"),
                      this.search = this.search === !1 ? !1 : !0,
                      void 0 === this.stype && (this.stype = "text"),
                      f = $.extend({}, this.searchoptions || {}, {
                          name: n.index || n.name,
                          id: "gs_" + c.p.idPrefix + n.name,
                          oper: "search"
                      }),
                      this.search) {
                          if (a.searchOperators) {
                              for (g = f.sopt ? f.sopt[0] : "select" === n.stype ? "eq" : a.defaultSearch,
                              h = 0; h < a.odata.length; h++)
                                  if (a.odata[h].oper === g) {
                                      p = a.operands[g] || "";
                                      break
                                  }
                              j = null != f.searchtitle ? f.searchtitle : a.operandTitle,
                              o = "<a title='" + j + "' style='padding-right: 0.5em;' soper='" + g + "' class='soptclass' colname='" + this.name + "'>" + p + "</a>"
                          }
                          switch ($("td:eq(0)", s).attr("colindex", b).append(o),
                          void 0 === f.clearSearch && (f.clearSearch = !0),
                          f.clearSearch ? (k = a.resetTitle || "Clear Search Value",
                          $("td:eq(2)", s).append("<a title='" + k + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>")) : $("td:eq(2)", s).hide(),
                          this.surl && (f.dataUrl = this.surl),
                          l = "",
                          f.defaultValue && (l = $.isFunction(f.defaultValue) ? f.defaultValue.call(c) : f.defaultValue),
                          m = $.jgrid.createEl.call(c, this.stype, f, l, !1, $.extend({}, $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})),
                          $(m).css({
                              width: "100%"
                          ...
                          $.jgrid.bindEv.call(c, m, f)
                      }
                      $(q).append(r),
                      $(i).append(q),
                      a.searchOperators || $("td:eq(0)", s).hide()
                  }),
                  $("table thead", c.grid.hDiv).append(i),
                  a.searchOperators && ($(".soptclass", i).click(function(a) {
                      var b = $(this).offset()
                        , c = b.left
                        , d = b.top;
                      h(this, c, d),
                  ...
                  $(".clearsearchclass", i).click(function() {
                      var b = $(this).parents("tr:first")
                        ...
                        , f = $.extend({}, c.p.colModel[d].searchoptions || {})
                        , g = f.defaultValue ? f.defaultValue : "";
                      "select" === c.p.colModel[d].stype ? g ? $("td.ui-search-input select", b).val(g) : $("td.ui-search-input select", b)[0].selectedIndex = 0 : $("td.ui-search-input input", b).val(g),
                      a.autosearch === !0 && e()
                  }),
      ...
      searchGrid: function(a) {
          ...
          this.each(function() {
              ...
              if (c.grid) {
                  ...
                  if ("string" == typeof i && (i = $.jgrid.parse(i)),
                  a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(),
                  void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0])
                      b($("#fbox_" + $.jgrid.jqID(c.p.id)));
                  else {
                      var j = $("<div><div id='" + e + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + $.jgrid.jqID(c.p.id))
                        , k = "left"
                        , l = "";
                      "rtl" === c.p.direction && (k = "right",
                      l = " style='text-align:left'",
                      j.attr("dir", "rtl"));
                      var m, n, o = $.extend([], c.p.colModel), p = "<a id='" + e + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + a.Find + "</a>", q = "<a id='" + e + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + a.Reset + "</a>", r = "", s = "", t = !1, u = -1;
                      if (a.showQuery && (r = "<a id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"),
                      a.columns.length ? (o = a.columns,
                      u = 0,
                      m = o[0].index || o[0].name) : $.each(o, function(a, b) {
                      ...
                      !i && m || a.multipleSearch === !1) {
                          var v = "eq";
                          u >= 0 && o[u].searchoptions && o[u].searchoptions.sopt ? v = o[u].searchoptions.sopt[0] : a.sopt && a.sopt.length && (v = a.sopt[0]),
                          i = {
                              groupOp: "AND",
                              rules: [{
                                  field: m,
                      ...
                      t = !1,
                      a.tmplNames && a.tmplNames.length && (t = !0,
                      s = a.tmplLabel,
                      ...
                      s += "</select>"),
                      n = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + k + "'>" + q + s + "</td><td class='EditButton' " + l + ">" + r + p + "</td></tr></tbody></table>",
                      e = $.jgrid.jqID(e),
                      $("#" + e).jqFilter({
                          columns: o,
                      ...
                      j.append(n),
                      t && a.tmplFilters && a.tmplFilters.length && $(".ui-template", j).bind("change", function() {
                          var b = $(this).val();
                      ...
                      a.gbox = "#gbox_" + e,
                      a.layer ? $.jgrid.createModal(h, j, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "#" + $.jgrid.jqID(a.layer), {
                          position: "relative"
                      }) : $.jgrid.createModal(h, j, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0]),
                      ...
                      r && $("#" + e + "_query").bind("click", function() {
                          return $(".queryresult", j).toggle(),
                          !1
                      }),
                      ...
                      b($("#" + e)),
                      $(".fm-button:not(.ui-state-disabled)", j).hover(function() {
                          $(this).addClass("ui-state-hover")
                      }, function() {
                          $(this).removeClass("ui-state-hover")
                      })
  ...
  if ($.jgrid.extend({
      editGridRow: function(a, b) {
          ...
          this.each(function() {
              function c() {
                  return $(v).find(".FormElement").each(function() {
                      ...
                      if (a.length) {
                          ...
                          $.each(n.p.colModel, function() {
                              if (this.name === c && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
                                  try {
                                      if (p[c] = this.editoptions.custom_value.call(n, $("#" + $.jgrid.jqID(c), v), "get"),
                                      void 0 === p[c])
                                          throw "e1"
                                  } catch (a) {
                                      "e1" === a ? $.jgrid.info_dialog(B.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.novalue, rp_ge[$(this)[0]].p.bClose) : $.jgrid.info_dialog(B.errcap, a.message, rp_ge[$(this)[0]].p.bClose)
                                  }
                                  return !0
                              }
                          })
                          ...
                          case "checkbox":
                              ...
                              break;
                          case "select-one":
                              p[this.name] = $("option:selected", this).val();
                              break;
                          ...
                          n.p.autoencode && (p[this.name] = $.jgrid.htmlEncode(p[this.name]))
                      }
                  }),
                  !0
              }
              function d(a, b, c, d) {
                  var e, f, g, h, i, j, k, l = 0, m = [], o = !1, p = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", q = "";
                  for (k = 1; d >= k; k++)
                      q += p;
                  if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)),
                  $(b.p.colModel).each(function(k) {
                      if (e = this.name,
                      f = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1,
                      i = f ? "style='display:none'" : "",
                      "cb" !== e && "subgrid" !== e && this.editable === !0 && "rn" !== e) {
                          if (o === !1)
                              h = "";
                          else if (e === b.p.ExpandColumn && b.p.treeGrid === !0)
                              h = $("td[role='gridcell']:eq(" + k + ")", b.rows[o]).text();
                          else {
                              try {
                                  h = $.unformat.call(b, $("td[role='gridcell']:eq(" + k + ")", b.rows[o]), {
                                      rowId: a,
                                      colModel: this
                                  }, k)
                              } catch (p) {
                                  h = this.edittype && "textarea" === this.edittype ? $("td[role='gridcell']:eq(" + k + ")", b.rows[o]).text() : $("td[role='gridcell']:eq(" + k + ")", b.rows[o]).html()
                              }
                          ...
                          var r = $.extend({}, this.editoptions || {}, {
                            ...
                            , u = parseInt(s.rowpos, 10) || l + 1
                            , v = parseInt(2 * (parseInt(s.colpos, 10) || 1), 10);
                          if ("_empty" === a && r.defaultValue && (h = $.isFunction(r.defaultValue) ? r.defaultValue.call(n) : r.defaultValue),
                          this.edittype || (this.edittype = "text"),
                          n.p.autoencode && (h = $.jgrid.htmlDecode(h)),
                          j = $.jgrid.createEl.call(n, this.edittype, r, h, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {})),
                          "select" === this.edittype && (h = $(j).val(),
                          "select-multiple" === $(j).get(0).type && (h = h.join(","))),
                          "checkbox" === this.edittype && (h = $(j).is(":checked") ? $(j).val() : $(j).attr("offval")),
                          (rp_ge[n.p.id].checkOnSubmit || rp_ge[n.p.id].checkOnUpdate) && (rp_ge[n.p.id]._savedData[e] = h),
                          $(j).addClass("FormElement"),
                          $.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && $(j).addClass("ui-widget-content ui-corner-all"),
                          A)
                              $(G).find("#" + e).replaceWith(j);
                          else {
                              if (g = $(c).find("tr[rowpos=" + u + "]"),
                              s.rowabove) {
                                  var w = $("<tr><td class='contentinfo' colspan='" + 2 * d + "'>" + s.rowcontent + "</td></tr>");
                                  $(c).append(w),
                                  w[0].rp = u
                              }
                              0 === g.length && (g = $("<tr " + i + " rowpos='" + u + "'></tr>").addClass("FormData").attr("id", "tr_" + e),
                              $(g).append(q),
                              $(c).append(g),
                              g[0].rp = u),
                              $("td:eq(" + (v - 2) + ")", g[0]).html(void 0 === s.label ? b.p.colNames[k] : s.label),
                              $("td:eq(" + (v - 1) + ")", g[0]).append(s.elmprefix).append(j).append(s.elmsuffix)
                          }
                          "custom" === this.edittype && $.isFunction(r.custom_value) && r.custom_value.call(n, $("#" + e, t), "set", h),
                          $.jgrid.bindEv.call(n, j, r),
                          m[l] = k,
                          l++
                      }
                  }),
                  l > 0) {
                      var r;
                      A ? (r = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/>",
                      $(G).append(r)) : (r = $("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * d - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/></td></tr>"),
                      r[0].rp = l + 999,
                      $(c).append(r)),
                      (rp_ge[n.p.id].checkOnSubmit || rp_ge[n.p.id].checkOnUpdate) && (rp_ge[n.p.id]._savedData[b.p.id + "_id"] = a)
                  }
                  return m
              }
              function e(a, b, c) {
                  var d, e, f, g, h, i, j = 0;
                  (rp_ge[n.p.id].checkOnSubmit || rp_ge[n.p.id].checkOnUpdate) && (rp_ge[n.p.id]._savedData = {},
                  rp_ge[n.p.id]._savedData[b.p.id + "_id"] = a);
                  var k = b.p.colModel;
                  if ("_empty" === a)
                      return $(k).each(function() {
                          ...
                          "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(n, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(n) : g.defaultValue,
                          ...
                          (rp_ge[n.p.id].checkOnSubmit === !0 || rp_ge[n.p.id].checkOnUpdate) && (rp_ge[n.p.id]._savedData[d] = h))
                      }),
                      void $("#id_g", c).val(a);
                  ...
                  l && ($('td[role="gridcell"]', l).each(function(f) {
                      ...
                      "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                          ...
                          switch (n.p.autoencode && (e = $.jgrid.htmlDecode(e)),
                          (rp_ge[n.p.id].checkOnSubmit === !0 || rp_ge[n.p.id].checkOnUpdate) && (rp_ge[n.p.id]._savedData[d] = e),
                          d = $.jgrid.jqID(d),
                          k[f].edittype) {
                          case "password":
                          case "text":
                          ...
                          case "select":
                              ...
                              (rp_ge[n.p.id].checkOnSubmit === !0 || rp_ge[n.p.id].checkOnUpdate) && (e = $("#" + d, c).val(),
                              k[f].editoptions.multiple && (e = e.join(",")),
                              rp_ge[n.p.id]._savedData[d] = e);
                              break;
                          case "checkbox":
                              if (e = String(e),
                              k[f].editoptions && k[f].editoptions.value) {
                                  var i = k[f].editoptions.value.split(":");
                                  $("#" + d, c)[n.p.useProp ? "prop" : "attr"](i[0] === e ? {
                                      checked: !0,
                                      defaultChecked: !0
                                  } : {
                                      checked: !1,
                                  ...
                                  e = e.toLowerCase(),
                                  e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e ? ($("#" + d, c)[n.p.useProp ? "prop" : "attr"]("checked", !0),
                                  $("#" + d, c)[n.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : ($("#" + d, c)[n.p.useProp ? "prop" : "attr"]("checked", !1),
                                  $("#" + d, c)[n.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                              (rp_ge[n.p.id].checkOnSubmit === !0 || rp_ge[n.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"));
                              break;
                          case "custom":
                              try {
                                  if (!k[f].editoptions || !$.isFunction(k[f].editoptions.custom_value))
                                      throw "e1";
                                  k[f].editoptions.custom_value.call(n, $("#" + d, c), "set", e)
                              } catch (l) {
                                  "e1" === l ? $.jgrid.info_dialog(B.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.nodefined, $.rp_ge[$(this)[0]].p.bClose) : $.jgrid.info_dialog(B.errcap, l.message, $.rp_ge[$(this)[0]].p.bClose)
                              }
                          }
                          j++
                      }
              ...
              function f() {
                  $.each(n.p.colModel, function(a, b) {
                      b.editoptions && b.editoptions.NullIfEmpty === !0 && p.hasOwnProperty(b.name) && "" === p[b.name] && (p[b.name] = "null")
                  })
              }
              function g() {
                  var a, c, d, g, h, i, j, k = [!0, "", ""], l = {}, m = n.p.prmNames, o = $(n).triggerHandler("jqGridAddEditBeforeCheckValues", [$(t), r]);
                  o && "object" == typeof o && (p = o),
                  $.isFunction(rp_ge[n.p.id].beforeCheckValues) && (o = rp_ge[n.p.id].beforeCheckValues.call(n, p, $(t), r),
                  o && "object" == typeof o && (p = o));
                  for (g in p)
                      if (p.hasOwnProperty(g) && (k = $.jgrid.checkValues.call(n, p[g], g),
                      k[0] === !1))
                          break;
                  if (f(),
                  k[0] && (l = $(n).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[n.p.id], p, r]),
                  void 0 === l && $.isFunction(rp_ge[n.p.id].onclickSubmit) && (l = rp_ge[n.p.id].onclickSubmit.call(n, rp_ge[n.p.id], p, r) || {}),
                  k = $(n).triggerHandler("jqGridAddEditBeforeSubmit", [p, $(t), r]),
                  void 0 === k && (k = [!0, "", ""]),
                  k[0] && $.isFunction(rp_ge[n.p.id].beforeSubmit) && (k = rp_ge[n.p.id].beforeSubmit.call(n, p, $(t), r))),
                  k[0] && !rp_ge[n.p.id].processing) {
                      if (rp_ge[n.p.id].processing = !0,
                      $("#sData", v + "_2").addClass("ui-state-active"),
                      j = rp_ge[n.p.id].url || $(n).jqGrid("getGridParam", "editurl"),
                      d = m.oper,
                      c = "clientArray" === j ? n.p.keyName : m.id,
                      p[d] = "_empty" === $.trim(p[n.p.id + "_id"]) ? m.addoper : m.editoper,
                      p[d] !== m.addoper ? p[c] = p[n.p.id + "_id"] : void 0 === p[c] && (p[c] = p[n.p.id + "_id"]),
                      delete p[n.p.id + "_id"],
                      p = $.extend(p, rp_ge[n.p.id].editData, l),
                      n.p.treeGrid === !0) {
                          if (p[d] === m.addoper) {
                              h = $(n).jqGrid("getGridParam", "selrow");
                              var q = "adjacency" === n.p.treeGridModel ? n.p.treeReader.parent_id_field : "parent_id";
                              p[q] = h
                          }
                          for (i in n.p.treeReader)
                              if (n.p.treeReader.hasOwnProperty(i)) {
                                  var u = n.p.treeReader[i];
                                  if (p.hasOwnProperty(u)) {
                                      if (p[d] === m.addoper && "parent_id_field" === i)
                                          continue;
                                      delete p[u]
                                  }
                              }
                      }
                      p[c] = $.jgrid.stripPref(n.p.idPrefix, p[c]);
                      var x = $.extend({
                          url: j,
                          type: rp_ge[n.p.id].mtype,
                          data: $.isFunction(rp_ge[n.p.id].serializeEditData) ? rp_ge[n.p.id].serializeEditData.call(n, p) : p,
                          complete: function(f, g) {
                              var i;
                              if ($("#sData", v + "_2").removeClass("ui-state-active"),
                              p[c] = n.p.idPrefix + p[c],
                              f.status >= 300 && 304 !== f.status ? (k[0] = !1,
                              k[1] = $(n).triggerHandler("jqGridAddEditErrorTextFormat", [f, r]),
                              k[1] = $.isFunction(rp_ge[n.p.id].errorTextFormat) ? rp_ge[n.p.id].errorTextFormat.call(n, f, r) : g + " Status: '" + f.statusText + "'. Error code: " + f.status) : (k = $(n).triggerHandler("jqGridAddEditAfterSubmit", [f, p, r]),
                              void 0 === k && (k = [!0, "", ""]),
                              k[0] && $.isFunction(rp_ge[n.p.id].afterSubmit) && (k = rp_ge[n.p.id].afterSubmit.call(n, f, p, r))),
                              k[0] === !1)
                                  $(".FormError", t).html(k[1]),
                                  $(".FormError", t).show();
                              else if (n.p.autoencode && $.each(p, function(a, b) {
                                  p[a] = $.jgrid.htmlDecode(b)
                              }),
                              p[d] === m.addoper ? (k[2] || (k[2] = $.jgrid.randId()),
                              null == p[c] || "_empty" === p[c] ? p[c] = k[2] : k[2] = p[c],
                              rp_ge[n.p.id].reloadAfterSubmit ? $(n).trigger("reloadGrid") : n.p.treeGrid === !0 ? $(n).jqGrid("addChildNode", k[2], h, p) : $(n).jqGrid("addRowData", k[2], p, b.addedrow),
                              rp_ge[n.p.id].closeAfterAdd ? (n.p.treeGrid !== !0 && $(n).jqGrid("setSelection", k[2]),
                              $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: "#gbox_" + $.jgrid.jqID(s),
                                  jqm: b.jqModal,
                                  onClose: rp_ge[n.p.id].onClose,
                                  removemodal: rp_ge[n.p.id].removemodal,
                                  formprop: !rp_ge[n.p.id].recreateForm,
                                  form: rp_ge[n.p.id].form
                              })) : rp_ge[n.p.id].clearAfterAdd && e("_empty", n, t)) : (rp_ge[n.p.id].reloadAfterSubmit ? ($(n).trigger("reloadGrid"),
                              rp_ge[n.p.id].closeAfterEdit || setTimeout(function() {
                                  $(n).jqGrid("setSelection", p[c])
                              }, 1e3)) : n.p.treeGrid === !0 ? $(n).jqGrid("setTreeRow", p[c], p) : $(n).jqGrid("setRowData", p[c], p),
                              rp_ge[n.p.id].closeAfterEdit && $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: "#gbox_" + $.jgrid.jqID(s),
                                  jqm: b.jqModal,
                                  onClose: rp_ge[n.p.id].onClose,
                                  removemodal: rp_ge[n.p.id].removemodal,
                              ...
                              $.isFunction(rp_ge[n.p.id].afterComplete) && (a = f,
                              setTimeout(function() {
                                  $(n).triggerHandler("jqGridAddEditAfterComplete", [a, p, $(t), r]),
                                  rp_ge[n.p.id].afterComplete.call(n, a, p, $(t), r),
                                  a = null
                              }, 500)),
                              (rp_ge[n.p.id].checkOnSubmit || rp_ge[n.p.id].checkOnUpdate) && ($(t).data("disabled", !1),
                              "_empty" !== rp_ge[n.p.id]._savedData[n.p.id + "_id"]))
                                  for (i in rp_ge[n.p.id]._savedData)
                                      rp_ge[n.p.id]._savedData.hasOwnProperty(i) && p[i] && (rp_ge[n.p.id]._savedData[i] = p[i]);
                              rp_ge[n.p.id].processing = !1;
                              try {
                                  $(":input:visible", t)[0].focus()
                              } catch (j) {}
                          }
                      }, $.jgrid.ajaxOptions, rp_ge[n.p.id].ajaxEditOptions);
                      if (x.url || rp_ge[n.p.id].useDataProxy || ($.isFunction(n.p.dataProxy) ? rp_ge[n.p.id].useDataProxy = !0 : (k[0] = !1,
                      k[1] += " " + B.nourl)),
                      k[0])
                          if (rp_ge[n.p.id].useDataProxy) {
                              var y = n.p.dataProxy.call(n, x, "set_" + n.p.id);
                              void 0 === y && (y = [!0, ""]),
                              y[0] === !1 ? (k[0] = !1,
                              k[1] = y[1] || "Error deleting the selected row!") : (x.data.oper === m.addoper && rp_ge[n.p.id].closeAfterAdd && $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: "#gbox_" + $.jgrid.jqID(s),
                                  jqm: b.jqModal,
                                  onClose: rp_ge[n.p.id].onClose,
                                  removemodal: rp_ge[n.p.id].removemodal,
                              ...
                              x.data.oper === m.editoper && rp_ge[n.p.id].closeAfterEdit && $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: "#gbox_" + $.jgrid.jqID(s),
                                  jqm: b.jqModal,
                                  onClose: rp_ge[n.p.id].onClose,
                                  removemodal: rp_ge[n.p.id].removemodal,
                              ...
                              "clientArray" === x.url ? (rp_ge[n.p.id].reloadAfterSubmit = !1,
                              p = x.data,
                              x.complete({
                                  status: 200,
                                  statusText: ""
              ...
              function i() {
                  var a = !0;
                  return $(".FormError", t).hide(),
                  rp_ge[n.p.id].checkOnUpdate && (p = {},
                  c(),
                  q = h(p, rp_ge[n.p.id]._savedData),
                  q && ($(t).data("disabled", !0),
                  $(".confirm", "#" + w.themodal).show(),
                  a = !1)),
                  a
              }
              function j() {
                  var b;
                  if ("_empty" !== a && void 0 !== n.p.savedRow && n.p.savedRow.length > 0 && $.isFunction($.fn.jqGrid.restoreRow))
                      for (b = 0; b < n.p.savedRow.length; b++)
                          if (n.p.savedRow[b].id === a) {
                              $(n).jqGrid("restoreRow", a);
                              break
                          }
              }
              function k(a, b) {
                  var c = b[1].length - 1;
                  0 === a ? $("#pData", o).addClass("ui-state-disabled") : void 0 !== b[1][a - 1] && $("#" + $.jgrid.jqID(b[1][a - 1])).hasClass("ui-state-disabled") ? $("#pData", o).addClass("ui-state-disabled") : $("#pData", o).removeClass("ui-state-disabled"),
                  a === c ? $("#nData", o).addClass("ui-state-disabled") : void 0 !== b[1][a + 1] && $("#" + $.jgrid.jqID(b[1][a + 1])).hasClass("ui-state-disabled") ? $("#nData", o).addClass("ui-state-disabled") : $("#nData", o).removeClass("ui-state-disabled")
              }
              function l() {
                  var a = $(n).jqGrid("getDataIDs")
                    , b = $("#id_g", v).val()
                    , c = $.inArray(b, a);
                  return [c, a]
              }
              ...
              var n = this;
              if (n.grid && a) {
                  var o, p, q, r, s = n.p.id, t = "FrmGrid_" + s, u = "TblGrid_" + s, v = "#" + $.jgrid.jqID(u), w = {
                      themodal: "editmod" + s,
                      modalhead: "edithd" + s,
                      modalcontent: "editcnt" + s,
                      scrollelm: t
                  }, x = !0, y = 1, z = 0, A = "string" == typeof rp_ge[n.p.id].template && rp_ge[n.p.id].template.length > 0, B = $.jgrid.getRegional(this, "errors");
                  "new" === a ? (a = "_empty",
                  r = "add",
                  b.caption = rp_ge[n.p.id].addCaption) : (b.caption = rp_ge[n.p.id].editCaption,
                  r = "edit"),
                  b.recreateForm || $(n).data("formProp") && $.extend(rp_ge[$(this)[0].p.id], $(n).data("formProp"));
                  var C = !0;
                  b.checkOnUpdate && b.jqModal && !b.modal && (C = !1);
                  var D, E = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px", F = isNaN(rp_ge[$(this)[0].p.id].datawidth) ? rp_ge[$(this)[0].p.id].datawidth : rp_ge[$(this)[0].p.id].datawidth + "px", G = $("<form name='FormPost' id='" + t + "' class='FormGrid' onSubmit='return false;' style='width:" + F + ";overflow:auto;position:relative;height:" + E + ";'></form>").data("disabled", !1);
                  if (A ? (D = m(rp_ge[$(this)[0].p.id].template),
                  o = v) : (D = $("<table id='" + u + "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                  o = v + "_2"),
                  t = "#" + $.jgrid.jqID(t),
                  $(G).append("<div class='FormError ui-state-error' style='display:none;'></div>"),
                  $(G).append("<div class='tinfo topinfo'>" + rp_ge[n.p.id].topinfo + "</div>"),
                  $(n.p.colModel).each(function() {
                      var a = this.formoptions;
                      y = Math.max(y, a ? a.colpos || 0 : 0),
                      z = Math.max(z, a ? a.rowpos || 0 : 0)
                  }),
                  $(G).append(D),
                  x = $(n).triggerHandler("jqGridAddEditBeforeInitData", [G, r]),
                  void 0 === x && (x = !0),
                  x && $.isFunction(rp_ge[n.p.id].beforeInitData) && (x = rp_ge[n.p.id].beforeInitData.call(n, G, r)),
                  x !== !1) {
                      j(),
                      d(a, n, D, y);
                      var H = "rtl" === n.p.direction ? !0 : !1
                        , I = H ? "nData" : "pData"
                        , J = H ? "pData" : "nData"
                        , K = "<a id='" + I + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>"
                        , L = "<a id='" + J + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>"
                        , M = "<a id='sData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>"
                        , N = "<a id='cData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>"
                        , O = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + u + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (H ? L + K : K + L) + "</td><td class='EditButton'>" + M + N + "</td></tr>";
                      if (O += "</tbody></table>",
                      z > 0) {
                          var P = [];
                          $.each($(D)[0].rows, function(a, b) {
                              P[a] = b
                          }),
                          P.sort(function(a, b) {
                      ...
                      b.gbox = "#gbox_" + $.jgrid.jqID(s);
                      var Q = !1;
                      b.closeOnEscape === !0 && (b.closeOnEscape = !1,
                      Q = !0);
                      var R;
                      if (A ? ($(G).find("#pData").replaceWith(K),
                      $(G).find("#nData").replaceWith(L),
                      $(G).find("#sData").replaceWith(M),
                      $(G).find("#cData").replaceWith(N),
                      R = $("<div id=" + u + "></div>").append(G)) : R = $("<div></div>").append(G).append(O),
                      $(G).append("<div class='binfo topinfo bottominfo'>" + rp_ge[n.p.id].bottominfo + "</div>"),
                      $.jgrid.createModal(w, R, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(n.p.id), $("#gbox_" + $.jgrid.jqID(n.p.id))[0]),
                      H && ($("#pData, #nData", v + "_2").css("float", "right"),
                      $(".EditButton", v + "_2").css("text-align", "left")),
                      rp_ge[n.p.id].topinfo && $(".tinfo", t).show(),
                      rp_ge[n.p.id].bottominfo && $(".binfo", t).show(),
                      R = null,
                      O = null,
                      $("#" + $.jgrid.jqID(w.themodal)).keydown(function(a) {
                          var c = a.target;
                          if ($(t).data("disabled") === !0)
                              return !1;
                          if (rp_ge[n.p.id].savekey[0] === !0 && a.which === rp_ge[n.p.id].savekey[1] && "TEXTAREA" !== c.tagName)
                              return $("#sData", v + "_2").trigger("click"),
                              !1;
                          if (27 === a.which)
                              return i() ? (Q && $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: b.gbox,
                                  jqm: b.jqModal,
                                  onClose: rp_ge[n.p.id].onClose,
                                  removemodal: rp_ge[n.p.id].removemodal,
                              ...
                              !1) : !1;
                          if (rp_ge[n.p.id].navkeys[0] === !0) {
                              if ("_empty" === $("#id_g", v).val())
                                  return !0;
                              if (a.which === rp_ge[n.p.id].navkeys[1])
                                  return $("#pData", o).trigger("click"),
                                  !1;
                              if (a.which === rp_ge[n.p.id].navkeys[2])
                                  return $("#nData", o).trigger("click"),
                                  !1
                          }
                      }),
                      b.checkOnUpdate && ($("a.ui-jqdialog-titlebar-close span", "#" + $.jgrid.jqID(w.themodal)).removeClass("jqmClose"),
                      $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(w.themodal)).unbind("click").click(function() {
                          return i() ? ($.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                              gb: "#gbox_" + $.jgrid.jqID(s),
                              jqm: b.jqModal,
                              onClose: rp_ge[n.p.id].onClose,
                              removemodal: rp_ge[n.p.id].removemodal,
                      ...
                      b.saveicon = $.extend([!0, "left", "ui-icon-disk"], b.saveicon),
                      b.closeicon = $.extend([!0, "left", "ui-icon-close"], b.closeicon),
                      b.saveicon[0] === !0 && $("#sData", o).addClass("right" === b.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.saveicon[2] + "'></span>"),
                      b.closeicon[0] === !0 && $("#cData", o).addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.closeicon[2] + "'></span>"),
                      rp_ge[n.p.id].checkOnSubmit || rp_ge[n.p.id].checkOnUpdate) {
                          M = "<a id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + b.bYes + "</a>",
                          L = "<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + b.bNo + "</a>",
                          N = "<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + b.bExit + "</a>";
                          var S = b.zIndex || 999;
                          S++,
                          $("<div class='" + b.overlayClass + " jqgrid-overlay confirm' style='z-index:" + S + ";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (S + 1) + "'>" + b.saveData + "<br/><br/>" + M + L + N + "</div>").insertAfter(t),
                          $("#sNew", "#" + $.jgrid.jqID(w.themodal)).click(function() {
                              return g(),
                              $(t).data("disabled", !1),
                              $(".confirm", "#" + $.jgrid.jqID(w.themodal)).hide(),
                              !1
                          }),
                          $("#nNew", "#" + $.jgrid.jqID(w.themodal)).click(function() {
                              return $(".confirm", "#" + $.jgrid.jqID(w.themodal)).hide(),
                              $(t).data("disabled", !1),
                              setTimeout(function() {
                                  $(":input:visible", t)[0].focus()
                              }, 0),
                          ...
                          $("#cNew", "#" + $.jgrid.jqID(w.themodal)).click(function() {
                              return $(".confirm", "#" + $.jgrid.jqID(w.themodal)).hide(),
                              $(t).data("disabled", !1),
                              $.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                                  gb: "#gbox_" + $.jgrid.jqID(s),
                      ...
                      $(n).triggerHandler("jqGridAddEditInitializeForm", [$(t), r]),
                      $.isFunction(rp_ge[n.p.id].onInitializeForm) && rp_ge[n.p.id].onInitializeForm.call(n, $(t), r),
                      "_empty" !== a && rp_ge[n.p.id].viewPagerButtons ? $("#pData,#nData", o).show() : $("#pData,#nData", o).hide(),
                      $(n).triggerHandler("jqGridAddEditBeforeShowForm", [$(t), r]),
                      $.isFunction(rp_ge[n.p.id].beforeShowForm) && rp_ge[n.p.id].beforeShowForm.call(n, $(t), r),
                      $("#" + $.jgrid.jqID(w.themodal)).data("onClose", rp_ge[n.p.id].onClose),
                      $.jgrid.viewModal("#" + $.jgrid.jqID(w.themodal), {
                          gbox: "#gbox_" + $.jgrid.jqID(s),
                          jqm: b.jqModal,
                          overlay: b.overlay,
                          modal: b.modal,
                          overlayClass: b.overlayClass,
                          onHide: function(a) {
                              var b = $("#editmod" + s)[0].style.height;
                      ...
                      C || $("." + $.jgrid.jqID(b.overlayClass)).click(function() {
                          return i() ? ($.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                              gb: "#gbox_" + $.jgrid.jqID(s),
                              jqm: b.jqModal,
                              onClose: rp_ge[n.p.id].onClose,
                      ...
                      $(".fm-button", "#" + $.jgrid.jqID(w.themodal)).hover(function() {
                          $(this).addClass("ui-state-hover")
                      }, function() {
                          $(this).removeClass("ui-state-hover")
                      }),
                      $("#sData", o).click(function() {
                          return p = {},
                          $(".FormError", t).hide(),
                          c(),
                          "_empty" === p[n.p.id + "_id"] ? g() : b.checkOnSubmit === !0 ? (q = h(p, rp_ge[n.p.id]._savedData),
                          q ? ($(t).data("disabled", !0),
                          $(".confirm", "#" + $.jgrid.jqID(w.themodal)).show()) : g()) : g(),
                          !1
                      }),
                      $("#cData", o).click(function() {
                          return i() ? ($.jgrid.hideModal("#" + $.jgrid.jqID(w.themodal), {
                              gb: "#gbox_" + $.jgrid.jqID(s),
                              jqm: b.jqModal,
                              onClose: rp_ge[n.p.id].onClose,
                      ...
                      $("#nData", o).click(function() {
                          ...
                          -1 !== a[0] && a[1][a[0] + 1]) {
                              $(n).triggerHandler("jqGridAddEditClickPgButtons", ["next", $(t), a[1][a[0]]]);
                              var c;
                              if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(n, "next", $(t), a[1][a[0]]),
                              void 0 !== c && c === !1))
                                  return !1;
                              if ($("#" + $.jgrid.jqID(a[1][a[0] + 1])).hasClass("ui-state-disabled"))
                                  return !1;
                              e(a[1][a[0] + 1], n, t),
                              $(n).jqGrid("setSelection", a[1][a[0] + 1]),
                              $(n).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", $(t), a[1][a[0]]]),
                              $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(n, "next", $(t), a[1][a[0] + 1]),
                              k(a[0] + 1, a)
                          }
                          return !1
                      }),
                      $("#pData", o).click(function() {
                          if (!i())
                              return !1;
                          $(".FormError", t).hide();
                          var a = l();
                          if (-1 !== a[0] && a[1][a[0] - 1]) {
                              $(n).triggerHandler("jqGridAddEditClickPgButtons", ["prev", $(t), a[1][a[0]]]);
                              var c;
                              if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(n, "prev", $(t), a[1][a[0]]),
                              void 0 !== c && c === !1))
                                  return !1;
                              if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass("ui-state-disabled"))
                                  return !1;
                              e(a[1][a[0] - 1], n, t),
                              $(n).jqGrid("setSelection", a[1][a[0] - 1]),
                              $(n).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", $(t), a[1][a[0]]]),
                              $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(n, "prev", $(t), a[1][a[0] - 1]),
                              k(a[0] - 1, a)
                          }
                          return !1
                      }),
                      $(n).triggerHandler("jqGridAddEditAfterShowForm", [$(t), r]),
                      $.isFunction(rp_ge[n.p.id].afterShowForm) && rp_ge[n.p.id].afterShowForm.call(n, $(t), r);
                      var T = l();
                      k(T[0], T)
                  }
              }
      ...
      viewGridRow: function(a, b) {
          ...
          this.each(function() {
              function c() {
                  (rp_ge[h.p.id].closeOnEscape === !0 || rp_ge[h.p.id].navkeys[0] === !0) && setTimeout(function() {
                      $(".ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(n.modalhead)).attr("tabindex", "-1").focus()
                  }, 0)
              }
              function d(a, c, d, e) {
                  var f, g, h, i, j, k, l, m, n, o = 0, p = [], q = !1, r = "<td class='CaptionTD form-view-label ui-widget-content' width='" + b.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", s = "", t = "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>", u = ["integer", "number", "currency"], v = 0, w = 0;
                  for (k = 1; e >= k; k++)
                      s += 1 === k ? r : t;
                  if ($(c.p.colModel).each(function() {
                      g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1,
                      g || "right" !== this.align || (this.formatter && -1 !== $.inArray(this.formatter, u) ? v = Math.max(v, parseInt(this.width, 10)) : w = Math.max(w, parseInt(this.width, 10)))
                  }),
                  l = 0 !== v ? v : 0 !== w ? w : 0,
                  q = $(c).jqGrid("getInd", a),
                  $(c.p.colModel).each(function(a) {
                      ...
                      n = "boolean" != typeof this.viewable ? !0 : this.viewable,
                      "cb" !== f && "subgrid" !== f && "rn" !== f && n) {
                          i = q === !1 ? "" : f === c.p.ExpandColumn && c.p.treeGrid === !0 ? $("td:eq(" + a + ")", c.rows[q]).text() : $("td:eq(" + a + ")", c.rows[q]).html(),
                          m = "right" === this.align && 0 !== l ? !0 : !1;
                          var b = $.extend({}, {
                              rowabove: !1,
                              rowcontent: ""
                          }, this.formoptions || {})
                            , k = parseInt(b.rowpos, 10) || o + 1
                            , r = parseInt(2 * (parseInt(b.colpos, 10) || 1), 10);
                          if (b.rowabove) {
                              var t = $("<tr><td class='contentinfo' colspan='" + 2 * e + "'>" + b.rowcontent + "</td></tr>");
                              $(d).append(t),
                              t[0].rp = k
                          }
                          h = $(d).find("tr[rowpos=" + k + "]"),
                          0 === h.length && (h = $("<tr " + j + " rowpos='" + k + "'></tr>").addClass("FormData").attr("id", "trv_" + f),
                          $(h).append(s),
                          $(d).append(h),
                          h[0].rp = k),
                          $("td:eq(" + (r - 2) + ")", h[0]).html("<b>" + (void 0 === b.label ? c.p.colNames[a] : b.label) + "</b>"),
                          $("td:eq(" + (r - 1) + ")", h[0]).append("<span>" + i + "</span>").attr("id", "v_" + f),
                          m && $("td:eq(" + (r - 1) + ") span", h[0]).css({
                              "text-align": "right",
                              width: l + "px"
                          }),
                          p[o] = a,
                  ...
                  o > 0) {
                      var x = $("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * e - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + a + "'/></td></tr>");
                      x[0].rp = o + 99,
                      $(d).append(x)
                  }
                  return p
              ...
              function f(a, b) {
                  var c = b[1].length - 1;
                  0 === a ? $("#pData", "#" + k + "_2").addClass("ui-state-disabled") : void 0 !== b[1][a - 1] && $("#" + $.jgrid.jqID(b[1][a - 1])).hasClass("ui-state-disabled") ? $("#pData", k + "_2").addClass("ui-state-disabled") : $("#pData", "#" + k + "_2").removeClass("ui-state-disabled"),
                  a === c ? $("#nData", "#" + k + "_2").addClass("ui-state-disabled") : void 0 !== b[1][a + 1] && $("#" + $.jgrid.jqID(b[1][a + 1])).hasClass("ui-state-disabled") ? $("#nData", k + "_2").addClass("ui-state-disabled") : $("#nData", "#" + k + "_2").removeClass("ui-state-disabled")
              }
              function g() {
                  var a = $(h).jqGrid("getDataIDs")
                    , b = $("#id_g", "#" + k).val()
                    , c = $.inArray(b, a);
                  return [c, a]
              }
              ...
              if (h.grid && a) {
                  var i = h.p.id
                    , j = "ViewGrid_" + $.jgrid.jqID(i)
                    , k = "ViewTbl_" + $.jgrid.jqID(i)
                    , l = "ViewGrid_" + i
                    , m = "ViewTbl_" + i
                    , n = {
                      themodal: "viewmod" + i,
                      modalhead: "viewhd" + i,
                      modalcontent: "viewcnt" + i,
                      scrollelm: j
                  }
                    , o = $.isFunction(rp_ge[h.p.id].beforeInitData) ? rp_ge[h.p.id].beforeInitData : !1
                    , p = !0
                    , q = 1
                    , r = 0;
                  b.recreateForm || $(h).data("viewProp") && $.extend(rp_ge[$(this)[0].p.id], $(h).data("viewProp"));
                  var s = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px"
                    , t = isNaN(rp_ge[$(this)[0].p.id].datawidth) ? rp_ge[$(this)[0].p.id].datawidth : rp_ge[$(this)[0].p.id].datawidth + "px"
                    , u = $("<form name='FormPost' id='" + l + "' class='FormGrid' style='width:" + t + ";overflow:auto;position:relative;height:" + s + ";'></form>")
                    , v = $("<table id='" + m + "' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                  if ($(h.p.colModel).each(function() {
                      var a = this.formoptions;
                      q = Math.max(q, a ? a.colpos || 0 : 0),
                      r = Math.max(r, a ? a.rowpos || 0 : 0)
                  }),
                  $(u).append(v),
                  o && (p = o.call(h, u),
                  void 0 === p && (p = !0)),
                  p !== !1) {
                      d(a, h, v, q);
                      var w = "rtl" === h.p.direction ? !0 : !1
                        , x = w ? "nData" : "pData"
                        , y = w ? "pData" : "nData"
                        , z = "<a id='" + x + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>"
                        , A = "<a id='" + y + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>"
                        , B = "<a id='cData' class='fm-button ui-state-default ui-corner-all'>" + b.bClose + "</a>";
                      if (r > 0) {
                          var C = [];
                          $.each($(v)[0].rows, function(a, b) {
                              C[a] = b
                          }),
                          C.sort(function(a, b) {
                              return a.rp > b.rp ? 1 : a.rp < b.rp ? -1 : 0
                      ...
                      b.gbox = "#gbox_" + $.jgrid.jqID(i);
                      var D = $("<div></div>").append(u).append("<table border='0' class='EditTable' id='" + k + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + b.labelswidth + "'>" + (w ? A + z : z + A) + "</td><td class='EditButton'>" + B + "</td></tr></tbody></table>");
                      $.jgrid.createModal(n, D, b, "#gview_" + $.jgrid.jqID(h.p.id), $("#gview_" + $.jgrid.jqID(h.p.id))[0]),
                      w && ($("#pData, #nData", "#" + k + "_2").css("float", "right"),
                      $(".EditButton", "#" + k + "_2").css("text-align", "left")),
                      b.viewPagerButtons || $("#pData, #nData", "#" + k + "_2").hide(),
                      D = null,
                      $("#" + n.themodal).keydown(function(a) {
                          if (27 === a.which)
                              return rp_ge[h.p.id].closeOnEscape && $.jgrid.hideModal("#" + $.jgrid.jqID(n.themodal), {
                                  gb: b.gbox,
                                  jqm: b.jqModal,
                                  onClose: b.onClose,
                                  removemodal: rp_ge[h.p.id].removemodal,
                                  formprop: !rp_ge[h.p.id].recreateForm,
                                  form: rp_ge[h.p.id].form
                              }),
                              !1;
                          if (b.navkeys[0] === !0) {
                              if (a.which === b.navkeys[1])
                                  return $("#pData", "#" + k + "_2").trigger("click"),
                                  !1;
                              if (a.which === b.navkeys[2])
                                  return $("#nData", "#" + k + "_2").trigger("click"),
                                  !1
                          }
                      }),
                      b.closeicon = $.extend([!0, "left", "ui-icon-close"], b.closeicon),
                      b.closeicon[0] === !0 && $("#cData", "#" + k + "_2").addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.closeicon[2] + "'></span>"),
                      $.isFunction(b.beforeShowForm) && b.beforeShowForm.call(h, $("#" + j)),
                      $.jgrid.viewModal("#" + $.jgrid.jqID(n.themodal), {
                          gbox: "#gbox_" + $.jgrid.jqID(i),
                          jqm: b.jqModal,
                          overlay: b.overlay,
                          modal: b.modal,
                          onHide: function(a) {
                      ...
                      $(".fm-button:not(.ui-state-disabled)", "#" + k + "_2").hover(function() {
                          $(this).addClass("ui-state-hover")
                      }, function() {
                          $(this).removeClass("ui-state-hover")
                      }),
                      c(),
                      $("#cData", "#" + k + "_2").click(function() {
                          return $.jgrid.hideModal("#" + $.jgrid.jqID(n.themodal), {
                              gb: "#gbox_" + $.jgrid.jqID(i),
                              jqm: b.jqModal,
                              onClose: b.onClose,
                              removemodal: rp_ge[h.p.id].removemodal,
                              formprop: !rp_ge[h.p.id].recreateForm,
                      ...
                      $("#nData", "#" + k + "_2").click(function() {
                          $("#FormError", "#" + k).hide();
                          var a = g();
                          return a[0] = parseInt(a[0], 10),
                          -1 !== a[0] && a[1][a[0] + 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(h, "next", $("#" + j), a[1][a[0]]),
                          e(a[1][a[0] + 1], h),
                          $(h).jqGrid("setSelection", a[1][a[0] + 1]),
                          $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(h, "next", $("#" + j), a[1][a[0] + 1]),
                          f(a[0] + 1, a)),
                          c(),
                          !1
                      }),
                      $("#pData", "#" + k + "_2").click(function() {
                          $("#FormError", "#" + k).hide();
                          var a = g();
                          return -1 !== a[0] && a[1][a[0] - 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(h, "prev", $("#" + j), a[1][a[0]]),
                          e(a[1][a[0] - 1], h),
                          $(h).jqGrid("setSelection", a[1][a[0] - 1]),
                          $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(h, "prev", $("#" + j), a[1][a[0] - 1]),
                          f(a[0] - 1, a)),
                          c(),
                          !1
                      });
      ...
      delGridRow: function(a, b) {
          ...
          this.each(function() {
              var c = this;
              if (c.grid && a) {
                  var d, e, f, g, h = $.isFunction(rp_ge[c.p.id].beforeShowForm), i = $.isFunction(rp_ge[c.p.id].afterShowForm), j = $.isFunction(rp_ge[c.p.id].beforeInitData) ? rp_ge[c.p.id].beforeInitData : !1, k = c.p.id, l = {}, m = !0, n = "DelTbl_" + $.jgrid.jqID(k), o = "DelTbl_" + k, p = {
                      themodal: "delmod" + k,
                      modalhead: "delhd" + k,
                  ...
                  void 0 !== $("#" + $.jgrid.jqID(p.themodal))[0]) {
                      if (j && (m = j.call(c, $("#" + n)),
                      void 0 === m && (m = !0)),
                      m === !1)
                          return;
                      ...
                      $("#dData", "#" + n).removeClass("ui-state-active")),
                      h && rp_ge[c.p.id].beforeShowForm.call(c, $("#" + n)),
                      ...
                      i && rp_ge[c.p.id].afterShowForm.call(c, $("#" + n))
                  } else {
                      var q = isNaN(rp_ge[c.p.id].dataheight) ? rp_ge[c.p.id].dataheight : rp_ge[c.p.id].dataheight + "px"
                        , r = isNaN(b.datawidth) ? b.datawidth : b.datawidth + "px"
                        , s = "<div id='" + o + "' class='formdata' style='width:" + r + ";overflow:auto;position:relative;height:" + q + ";'>";
                      s += "<table class='DelTable'><tbody>",
                      s += "<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",
                      s += "<tr id='DelData' style='display:none'><td >" + a + "</td></tr>",
                      s += '<tr><td class="delmsg" style="white-space:pre;">' + rp_ge[c.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>",
                      s += "</tbody></table></div>";
                      var t = "<a id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>"
                        , u = "<a id='eData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>";
                      if (s += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + n + "_2'><tbody><tr><td><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + t + "&#160;" + u + "</td></tr></tbody></table>",
                      b.gbox = "#gbox_" + $.jgrid.jqID(k),
                      $.jgrid.createModal(p, s, b, "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0]),
                      j && (m = j.call(c, $(s)),
                      void 0 === m && (m = !0)),
                      m === !1)
                          return;
                      $(".fm-button", "#" + n + "_2").hover(function() {
                          $(this).addClass("ui-state-hover")
                      }, function() {
                          $(this).removeClass("ui-state-hover")
                      }),
                      b.delicon = $.extend([!0, "left", "ui-icon-scissors"], rp_ge[c.p.id].delicon),
                      b.cancelicon = $.extend([!0, "left", "ui-icon-cancel"], rp_ge[c.p.id].cancelicon),
                      b.delicon[0] === !0 && $("#dData", "#" + n + "_2").addClass("right" === b.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.delicon[2] + "'></span>"),
                      b.cancelicon[0] === !0 && $("#eData", "#" + n + "_2").addClass("right" === b.cancelicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.cancelicon[2] + "'></span>"),
                      $("#dData", "#" + n + "_2").click(function() {
                          var a, h = [!0, ""], i = $("#DelData>td", "#" + n).text();
                          if (l = {},
                          $.isFunction(rp_ge[c.p.id].onclickSubmit) && (l = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], i) || {}),
                          $.isFunction(rp_ge[c.p.id].beforeSubmit) && (h = rp_ge[c.p.id].beforeSubmit.call(c, i)),
                          h[0] && !rp_ge[c.p.id].processing) {
                              if (rp_ge[c.p.id].processing = !0,
                              f = c.p.prmNames,
                              d = $.extend({}, rp_ge[c.p.id].delData, l),
                              g = f.oper,
                              d[g] = f.deloper,
                              e = f.id,
                              i = String(i).split(","),
                              !i.length)
                                  return !1;
                              for (a in i)
                                  i.hasOwnProperty(a) && (i[a] = $.jgrid.stripPref(c.p.idPrefix, i[a]));
                              d[e] = i.join(),
                              ...
                              var j = $.extend({
                                  ...
                                  complete: function(a, e) {
                                      var f;
                                      if ($("#dData", "#" + n + "_2").removeClass("ui-state-active"),
                                      a.status >= 300 && 304 !== a.status ? (h[0] = !1,
                                      h[1] = $.isFunction(rp_ge[c.p.id].errorTextFormat) ? rp_ge[c.p.id].errorTextFormat.call(c, a) : e + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (h = rp_ge[c.p.id].afterSubmit.call(c, a, d)),
                                      h[0] === !1)
                                          $("#DelError>td", "#" + n).html(h[1]),
                                          $("#DelError", "#" + n).show();
                                      else {
                                          if (rp_ge[c.p.id].reloadAfterSubmit && "local" !== c.p.datatype)
                                              ...
                                              if (c.p.treeGrid === !0)
                                                  try {
                                                      $(c).jqGrid("delTreeNode", c.p.idPrefix + i[0])
                                                  } catch (g) {}
                                              else
                                                  for (f = 0; f < i.length; f++)
                                                      $(c).jqGrid("delRowData", c.p.idPrefix + i[f]);
                                              c.p.selrow = null,
                                              c.p.selarrrow = []
                                          }
                                          $.isFunction(rp_ge[c.p.id].afterComplete) && setTimeout(function() {
                                              rp_ge[c.p.id].afterComplete.call(c, a, i)
                                          }, 500)
                                      }
                                      rp_ge[c.p.id].processing = !1,
                                      h[0] && $.jgrid.hideModal("#" + $.jgrid.jqID(p.themodal), {
                              ...
                              if (j.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = !0 : (h[0] = !1,
                              h[1] += " " + $.jgrid.getRegional(c, "errors.nourl"))),
                              h[0])
                                  if (rp_ge[c.p.id].useDataProxy) {
                                      var m = c.p.dataProxy.call(c, j, "del_" + c.p.id);
                                      void 0 === m && (m = [!0, ""]),
                                      m[0] === !1 ? (h[0] = !1,
                                      h[1] = m[1] || "Error deleting the selected row!") : $.jgrid.hideModal("#" + $.jgrid.jqID(p.themodal), {
                                          gb: "#gbox_" + $.jgrid.jqID(k),
                                          jqm: b.jqModal,
                                          onClose: rp_ge[c.p.id].onClose
                                      })
                                  } else
                                      "clientArray" === j.url ? (d = j.data,
                                      j.complete({
                                          status: 200,
                                          statusText: ""
                                      }, "")) : $.ajax(j)
                          }
                          return h[0] === !1 && ($("#DelError>td", "#" + n).html(h[1]),
                          $("#DelError", "#" + n).show()),
                          !1
                      }),
                      $("#eData", "#" + n + "_2").click(function() {
      ...
      navGrid: function(a, b, c, d, e, f, g) {
          ...
          this.each(function() {
              if (!this.p.navGrid) {
                  ...
                  if (m.grid && "string" == typeof a) {
                      $(m).data("navGrid") || $(m).data("navGrid", b),
                      k = $(m).data("navGrid"),
                      m.p.force_regional && (k = $.extend(k, h)),
                      void 0 === $("#" + l.themodal)[0] && (k.alerttop || k.alertleft || (void 0 !== window.innerWidth ? (k.alertleft = window.innerWidth,
                      k.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (k.alertleft = document.documentElement.clientWidth,
                      k.alerttop = document.documentElement.clientHeight) : (k.alertleft = 1024,
                      k.alerttop = 768),
                      k.alertleft = k.alertleft / 2 - parseInt(k.alertwidth, 10) / 2,
                      k.alerttop = k.alerttop / 2 - 25),
                      $.jgrid.createModal(l, "<div>" + k.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                          gbox: "#gbox_" + $.jgrid.jqID(m.p.id),
                          jqModal: !0,
                          drag: !0,
                          resize: !0,
                          caption: k.alertcap,
                          ...
                          left: k.alertleft,
                          width: k.alertwidth,
                          height: k.alertheight,
                          closeOnEscape: k.closeOnEscape,
                          zIndex: k.alertzIndex
                      }, "#gview_" + $.jgrid.jqID(m.p.id), $("#gbox_" + $.jgrid.jqID(m.p.id))[0], !0));
                      var n, o = 1, p = function() {
                          $(this).hasClass("ui-state-disabled") || $(this).addClass("ui-state-hover")
                      }, q = function() {
                          $(this).removeClass("ui-state-hover")
                      };
                      for (k.cloneToTop && m.p.toppager && (o = 2),
                      n = 0; o > n; n++) {
                          var r, s, t, u = $("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), v = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>";
                          0 === n ? (s = a,
                          t = m.p.id,
                          s === m.p.toppager && (t += "_top",
                          o = 1)) : (s = m.p.toppager,
                          t = m.p.id + "_top"),
                          "rtl" === m.p.direction && $(u).attr("dir", "rtl").css("float", "right"),
                          d = d || {},
                          k.add && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.addicon + "'></span>" + k.addtext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.addtitle || "",
                              id: d.id || "add_" + t
                          }).click(function() {
                              return $(this).hasClass("ui-state-disabled") || ($.isFunction(k.addfunc) ? k.addfunc.call(m) : $(m).jqGrid("editGridRow", "new", d)),
                              !1
                          }).hover(p, q),
                          r = null),
                          c = c || {},
                          k.edit && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.editicon + "'></span>" + k.edittext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.edittitle || "",
                              id: c.id || "edit_" + t
                              ...
                              if (!$(this).hasClass("ui-state-disabled")) {
                                  var a = m.p.selrow;
                                  a ? $.isFunction(k.editfunc) ? k.editfunc.call(m, a) : $(m).jqGrid("editGridRow", a, c) : ($.jgrid.viewModal("#" + l.themodal, {
                                      gbox: "#gbox_" + $.jgrid.jqID(m.p.id),
                                      jqm: !0
                                  }),
                                  $("#jqg_alrt").focus())
                          ...
                          r = null),
                          g = g || {},
                          k.view && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.viewicon + "'></span>" + k.viewtext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.viewtitle || "",
                              id: g.id || "view_" + t
                              ...
                              if (!$(this).hasClass("ui-state-disabled")) {
                                  var a = m.p.selrow;
                                  a ? $.isFunction(k.viewfunc) ? k.viewfunc.call(m, a) : $(m).jqGrid("viewGridRow", a, g) : ($.jgrid.viewModal("#" + l.themodal, {
                                      gbox: "#gbox_" + $.jgrid.jqID(m.p.id),
                                      jqm: !0
                                  }),
                                  $("#jqg_alrt").focus())
                          ...
                          r = null),
                          e = e || {},
                          k.del && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.delicon + "'></span>" + k.deltext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.deltitle || "",
                              id: e.id || "del_" + t
                              ...
                              if (!$(this).hasClass("ui-state-disabled")) {
                                  var a;
                                  m.p.multiselect ? (a = m.p.selarrrow,
                                  0 === a.length && (a = null)) : a = m.p.selrow,
                                  a ? $.isFunction(k.delfunc) ? k.delfunc.call(m, a) : $(m).jqGrid("delGridRow", a, e) : ($.jgrid.viewModal("#" + l.themodal, {
                                      gbox: "#gbox_" + $.jgrid.jqID(m.p.id),
                                      jqm: !0
                                  }),
                                  $("#jqg_alrt").focus())
                          ...
                          r = null),
                          (k.add || k.edit || k.del || k.view) && $("tr", u).append(v),
                          f = f || {},
                          k.search && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.searchicon + "'></span>" + k.searchtext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.searchtitle || "",
                              id: f.id || "search_" + t
                          }).click(function() {
                              return $(this).hasClass("ui-state-disabled") || ($.isFunction(k.searchfunc) ? k.searchfunc.call(m, f) : $(m).jqGrid("searchGrid", f)),
                              !1
                          }).hover(p, q),
                          f.showOnLoad && f.showOnLoad === !0 && $(r, u).click(),
                          r = null),
                          k.refresh && (r = $("<td class='ui-pg-button ui-corner-all'></td>"),
                          $(r).append("<div class='ui-pg-div'><span class='ui-icon " + k.refreshicon + "'></span>" + k.refreshtext + "</div>"),
                          $("tr", u).append(r),
                          $(r, u).attr({
                              title: k.refreshtitle || "",
                              id: "refresh_" + t
                          }).click(function() {
                              if (!$(this).hasClass("ui-state-disabled")) {
                                  $.isFunction(k.beforeRefresh) && k.beforeRefresh.call(m),
                                  m.p.search = !1,
                                  m.p.resetsearch = !0;
                                  try {
                                      if ("currentfilter" !== k.refreshstate) {
                                          var a = m.p.id;
                                          m.p.postData.filters = "";
                                          try {
                                              $("#fbox_" + $.jgrid.jqID(a)).jqFilter("resetFilter")
                                          } catch (b) {}
                                          $.isFunction(m.clearToolbar) && m.clearToolbar.call(m, !1)
                                      }
                                  } catch (c) {}
                                  switch (k.refreshstate) {
                                  case "firstpage":
                                  ...
                                  $.isFunction(k.afterRefresh) && k.afterRefresh.call(m)
                              }
                              return !1
                          }).hover(p, q),
                          r = null),
                          j = $(".ui-jqgrid").css("font-size") || "11px",
                          $("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + j + ";visibility:hidden;' ></div>"),
                          i = $(u).clone().appendTo("#testpg2").width(),
                          $("#testpg2").remove(),
                          $(s + "_" + k.position, s).append(u),
                          m.p._nvtd && (i > m.p._nvtd[0] && ($(s + "_" + k.position, s).width(i),
                          m.p._nvtd[0] = i),
                          m.p._nvtd[1] = i),
                          j = null,
                          i = null,
                      ...
                      m.p.storeNavOptions && (m.p.navOptions = k,
                      m.p.editOptions = c,
                      m.p.addOptions = d,
                      m.p.delOptions = e,
                      m.p.searchOptions = f,
          ...
          this.each(function() {
              if (this.grid) {
                  ...
                  var c = $(".navtable", a)[0]
                    , d = this;
                  if (c) {
                      if (b.id && void 0 !== $("#" + $.jgrid.jqID(b.id), c)[0])
                          return;
                      var e = $("<td></td>");
                      $(e).addClass("ui-pg-button ui-corner-all").append("NONE" === b.buttonicon.toString().toUpperCase() ? "<div class='ui-pg-div'>" + b.caption + "</div>" : "<div class='ui-pg-div'><span class='ui-icon " + b.buttonicon + "'></span>" + b.caption + "</div>"),
                      b.id && $(e).attr("id", b.id),
                      "first" === b.position ? 0 === c.rows[0].cells.length ? $("tr", c).append(e) : $("tr td:eq(0)", c).before(e) : $("tr", c).append(e),
                      $(e, c).attr("title", b.title || "").click(function(a) {
                          return $(this).hasClass("ui-state-disabled") || $.isFunction(b.onClickButton) && b.onClickButton.call(d, a),
                          !1
                      }).hover(function() {
                          $(this).hasClass("ui-state-disabled") || $(this).addClass("ui-state-hover")
                      }, function() {
      ...
      navSeparatorAdd: function(a, b) {
          ...
          this.each(function() {
              if (this.grid) {
                  ...
                  var c = $(".navtable", a)[0];
                  if (c) {
                      var d = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='" + b.sepclass + "'></span>" + b.sepcontent + "</td>";
                      "first" === b.position ? 0 === c.rows[0].cells.length ? $("tr", c).append(d) : $("tr td:eq(0)", c).before(d) : $("tr", c).append(d)
                  }
              }
          })
      },
  ...
  $.jgrid.extend({
      ...
      groupingRender: function(a, b, c, d) {
          return this.each(function() {
              ...
              var g, h, i, j = this, k = j.p.groupingView, l = "", m = "", n = k.groupCollapse ? k.plusicon : k.minusicon, o = [], p = k.groupField.length;
              n += " tree-wrap-" + j.p.direction,
              ...
              var q, r = 0, s = $.makeArray(k.groupSummary);
              s.reverse(),
              q = j.p.multiselect ? ' colspan="2"' : "",
              $.each(k.groups, function(e, t) {
                  if (k._locgr && !(t.startRow + t.cnt > (c - 1) * d && t.startRow < c * d))
                      return !0;
                  r++,
                  h = j.p.id + "ghead_" + t.idx,
                  g = h + "_" + e,
                  m = "<span style='cursor:pointer;' class='ui-icon " + n + "' onclick=\"jQuery('#" + $.jgrid.jqID(j.p.id) + "').jqGrid('groupingToggle','" + g + "');return false;\"></span>";
                  try {
                      $.isArray(k.formatDisplayField) && $.isFunction(k.formatDisplayField[t.idx]) ? (t.displayValue = k.formatDisplayField[t.idx].call(j, t.displayValue, t.value, j.p.colModel[o[t.idx]], t.idx, k),
                      i = t.displayValue) : i = j.formatter(g, t.displayValue, o[t.idx], t.value)
                  } catch (u) {
                      i = t.displayValue
                  }
                  var v = "";
                  v = $.isFunction(k.groupText[t.idx]) ? k.groupText[t.idx].call(j, i, t.cnt, t.summary) : $.jgrid.template(k.groupText[t.idx], i, t.cnt, t.summary),
                  "string" != typeof v && "number" != typeof v && (v = i),
                  "header" === k.groupSummaryPos[t.idx] ? (l += '<tr id="' + g + '"' + (k.groupCollapse && t.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * t.idx + 'px;"' + q + ">" + m + v + "</td>",
                  l += f(e, 0, k.groups, k.groupColumnShow[t.idx] === !1 ? "" === q ? 2 : 3 : "" === q ? 1 : 2),
                  l += "</tr>") : l += '<tr id="' + g + '"' + (k.groupCollapse && t.idx > 0 ? ' style="display:none;" ' : " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + j.p.direction + " " + h + '"><td style="padding-left:' + 12 * t.idx + 'px;" colspan="' + (k.groupColumnShow[t.idx] === !1 ? b - 1 : b) + '">' + m + v + "</td></tr>";
                  var w = p - 1 === t.idx;
                  if (w) {
                      var x, y, z = k.groups[e + 1], A = 0, B = t.startRow, C = void 0 !== z ? z.startRow : k.groups[e].startRow + k.groups[e].cnt;
                      for (k._locgr && (A = (c - 1) * d,
                      A > t.startRow && (B = A)),
                      x = B; C > x && a[x - A]; x++)
                          l += a[x - A].join("");
                      if ("header" !== k.groupSummaryPos[t.idx]) {
                          var D;
                          if (void 0 !== z) {
                              for (D = 0; D < k.groupField.length && z.dataIndex !== k.groupField[D]; D++)
                                  ;
                              r = k.groupField.length - D
                          }
                          for (y = 0; r > y; y++)
                              if (s[y]) {
                                  var E = "";
                                  k.groupCollapse && !k.showSummaryOnHide && (E = ' style="display:none;"'),
                                  l += "<tr" + E + ' jqfootlevel="' + (t.idx - y) + '" role="row" class="ui-widget-content jqfoot ui-row-' + j.p.direction + '">',
                                  l += f(e, y, k.groups, 0),
                                  l += "</tr>"
                              }
                          r = D
      ...
      setGroupHeaders: function(a) {
          ...
          this.each(function() {
              ...
              var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p = this, q = 0, r = p.p.colModel, s = r.length, t = p.grid.headers, u = $("table.ui-jqgrid-htable", p.grid.hDiv), v = u.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header"), w = u.children("thead"), x = u.find(".jqg-first-row-header");
              void 0 === x[0] ? x = $("<tr>", {
                  role: "row",
                  "aria-hidden": "true"
              ...
              b = 0; s > b; b++)
                  ...
                  i >= 0) {
                      ...
                      e = $("<th>").attr({
                          role: "columnheader"
                      }).addClass("ui-state-default ui-th-column-header ui-th-" + p.p.direction + " " + n).html(l),
  ...
  $.jgrid.extend({
          ...
          this.each(function() {
              ...
              $('td[role="gridcell"]', e).each(function(d) {
                  ...
                  f[d].editable === !0)) {
                      ...
                      ("&nbsp;" === c || "&#160;" === c || 1 === c.length && 160 === c.charCodeAt(0)) && (c = "");
                      var m = $.jgrid.createEl.call(h, f[d].edittype, j, c, !0, $.extend({}, $.jgrid.ajaxOptions, h.p.ajaxSelectOptions || {}));
                      $(m).addClass("editable"),
                      e ? $("span:first", this).append(m) : $(this).append(m),
                      $.jgrid.bindEv.call(h, m, j),
                      "select" === f[d].edittype && void 0 !== f[d].editoptions && f[d].editoptions.multiple === !0 && void 0 === f[d].editoptions.dataUrl && $.jgrid.msie && $(m).width($(m).width()),
                      i++
                  }
              }),
              i > 0 && (l.id = a,
              ...
              j.keys === !0 && $(e).bind("keydown", function(b) {
                  if (27 === b.keyCode) {
      ...
      saveRow: function(a, b, c, d, e, f, g) {
          ...
          o === !1)
              return p;
          var u = $.jgrid.getRegional(this, "errors")
            , v = $.jgrid.getRegional(this, "edit")
            , w = $.isFunction(i.beforeSaveRow) ? i.beforeSaveRow.call(j, i, a) : void 0;
          if (void 0 === w && (w = !0),
          w) {
              ...
              "1" === l) {
                  ...
                  if ($('td[role="gridcell"]', o).each(function(a) {
                      if (x = j.p.colModel[a],
                      k = x.name,
                      "cb" !== k && "subgrid" !== k && x.editable === !0 && "rn" !== k && !$(this).hasClass("not-editable-cell")) {
                          switch (x.edittype) {
                          case "checkbox":
                              var b = ["Yes", "No"];
                              x.editoptions && (b = x.editoptions.value.split(":")),
                          ...
                          case "select":
                              ...
                              x.formatter && "select" === x.formatter && (r = {});
                              break;
                          case "custom":
                              try {
                                  if (!x.editoptions || !$.isFunction(x.editoptions.custom_value))
                                      throw "e1";
                                  if (q[k] = x.editoptions.custom_value.call(j, $(".customelement", this), "get"),
                                  void 0 === q[k])
                                      throw "e2"
                              } catch (e) {
                                  "e1" === e && $.jgrid.info_dialog(u.errcap, "function 'custom_value' " + v.msg.nodefined, v.bClose),
                                  "e2" === e ? $.jgrid.info_dialog(u.errcap, "function 'custom_value' " + v.msg.novalue, v.bClose) : $.jgrid.info_dialog(u.errcap, e.message, v.bClose)
                              }
                          }
                          ...
                          "clientArray" !== i.url && x.editoptions && x.editoptions.NullIfEmpty === !0 && "" === q[k] && (s[k] = "null",
                          t = !0)
                      }
                  }),
                  n[0] === !1) {
                      try {
                          var y = $(j).jqGrid("getGridRowById", a)
                            , z = $.jgrid.findPos(y);
                          $.jgrid.info_dialog(u.errcap, n[1], v.bClose, {
                              left: z[0],
                              top: z[1] + $(y).outerHeight()
                          })
                      } catch (A) {
                          alert(n[1])
                      }
                  ...
                  var B, C = j.p.prmNames, D = a;
                  if (B = j.p.keyName === !1 ? C.id : j.p.keyName,
                  q) {
                      if (q[C.oper] = C.editoper,
                      void 0 === q[B] || "" === q[B])
                          q[B] = a;
                      else if (o.id !== j.p.idPrefix + q[B]) {
                          var E = $.jgrid.stripPref(j.p.idPrefix, a);
                          if (void 0 !== j.p._index[E] && (j.p._index[q[B]] = j.p._index[E],
                          delete j.p._index[E]),
                          a = j.p.idPrefix + q[B],
                          $(o).attr("id", a),
                          j.p.selrow === D && (j.p.selrow = a),
                          $.isArray(j.p.selarrrow)) {
                              var F = $.inArray(D, j.p.selarrrow);
                              F >= 0 && (j.p.selarrrow[F] = a)
                          }
                          if (j.p.multiselect) {
                              var G = "jqg_" + j.p.id + "_" + a;
                              $("input.cbox", o).attr("id", G).attr("name", G)
                          }
                      }
                  ...
                  if ("clientArray" === i.url) {
                      ...
                      var H, I = $(j).jqGrid("setRowData", a, q);
                      for ($(o).attr("editable", "0"),
                      H = 0; H < j.p.savedRow.length; H++)
                          if (String(j.p.savedRow[H].id) === String(D)) {
                              m = H;
                              break
                          }
                      m >= 0 && j.p.savedRow.splice(m, 1),
                      $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, I, q, i]),
                      $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, I, q, i),
                      p = !0,
                      ...
                      s = $.extend({}, q, s),
                      s[B] = $.jgrid.stripPref(j.p.idPrefix, s[B]),
                      $.ajax($.extend({
                          url: i.url,
                          ...
                          error: function(b, c, d) {
                              ...
                              $.isFunction(i.errorfunc))
                                  ...
                                  try {
                                      $.jgrid.info_dialog(u.errcap, '<div class="ui-state-error">' + e + "</div>", v.bClose, {
                                          buttonalign: "right"
                                      })
                                  } catch (f) {
                                      alert(e)
      ...
      inlineNav: function(a, b) {
          var c = $.jgrid.getRegional(this[0], "nav");
          return b = $.extend(!0, {
              edit: !0,
              editicon: "ui-icon-pencil",
              add: !0,
          ...
          this.each(function() {
              if (this.grid && !this.p.inlineNav) {
                  var d = this
                    , e = $.jgrid.jqID(d.p.id);
                  if (d.p.navGrid || $(d).jqGrid("navGrid", a, {
                      refresh: !1,
                      edit: !1,
                      add: !1,
                      del: !1,
                  ...
                  $(d).data("inlineNav") || $(d).data("inlineNav", b),
                  d.p.force_regional && (b = $.extend(b, c)),
                  d.p.inlineNav = !0,
                  b.addParams.useFormatter === !0) {
                      var f, g = d.p.colModel;
                      for (f = 0; f < g.length; f++)
                          if (g[f].formatter && "actions" === g[f].formatter) {
                              if (g[f].formatoptions) {
                                  var h = {
                                      keys: !1,
                                      onEdit: null,
                                      onSuccess: null,
                  ...
                  b.add && $(d).jqGrid("navButtonAdd", a, {
                      caption: b.addtext,
                      title: b.addtitle,
                      buttonicon: b.addicon,
                      id: d.p.id + "_iladd",
                      onClickButton: function() {
                          $(d).jqGrid("addRow", b.addParams),
                          b.addParams.useFormatter || ($("#" + e + "_ilsave").removeClass("ui-state-disabled"),
                          $("#" + e + "_ilcancel").removeClass("ui-state-disabled"),
                          $("#" + e + "_iladd").addClass("ui-state-disabled"),
                          $("#" + e + "_iledit").addClass("ui-state-disabled"))
                      }
                  }),
                  b.edit && $(d).jqGrid("navButtonAdd", a, {
                      caption: b.edittext,
                      title: b.edittitle,
                      buttonicon: b.editicon,
                      id: d.p.id + "_iledit",
                      onClickButton: function() {
                          var a = $(d).jqGrid("getGridParam", "selrow");
                          a ? ($(d).jqGrid("editRow", a, b.editParams),
                          $("#" + e + "_ilsave").removeClass("ui-state-disabled"),
                          $("#" + e + "_ilcancel").removeClass("ui-state-disabled"),
                          $("#" + e + "_iladd").addClass("ui-state-disabled"),
                          $("#" + e + "_iledit").addClass("ui-state-disabled")) : ($.jgrid.viewModal("#alertmod_" + e, {
                              gbox: "#gbox_" + e,
                              jqm: !0
                          }),
                          $("#jqg_alrt").focus())
                  ...
                  b.save && ($(d).jqGrid("navButtonAdd", a, {
                      caption: b.savetext || "",
                      title: b.savetitle || "Save row",
                      buttonicon: b.saveicon,
                      id: d.p.id + "_ilsave",
                      onClickButton: function() {
                          var a = d.p.savedRow[0].id;
                          if (a) {
                              var c = d.p.prmNames
                                , f = c.oper
                                , g = b.editParams;
                              $("#" + $.jgrid.jqID(a), "#" + e).hasClass("jqgrid-new-row") ? (b.addParams.addRowParams.extraparam[f] = c.addoper,
                              g = b.addParams.addRowParams) : (b.editParams.extraparam || (b.editParams.extraparam = {}),
                              b.editParams.extraparam[f] = c.editoper),
                              $(d).jqGrid("saveRow", a, g) && $(d).jqGrid("showAddEditButtons")
                          } else
                  ...
                  $("#" + e + "_ilsave").addClass("ui-state-disabled")),
                  b.cancel && ($(d).jqGrid("navButtonAdd", a, {
                      ...
                      onClickButton: function() {
                          var a = d.p.savedRow[0].id
                            , c = b.editParams;
                          a ? ($("#" + $.jgrid.jqID(a), "#" + e).hasClass("jqgrid-new-row") && (c = b.addParams.addRowParams),
                          $(d).jqGrid("restoreRow", a, c),
                          $(d).jqGrid("showAddEditButtons")) : ($.jgrid.viewModal("#alertmod", {
                              gbox: "#gbox_" + e,
                              jqm: !0
                          }),
                          $("#jqg_alrt").focus())
                  ...
                  $("#" + e + "_ilcancel").addClass("ui-state-disabled")),
                  b.restoreAfterSelect === !0 && $(d).bind("jqGridBeforeSelectRow.inlineNav", function(a, c) {
                      d.p.savedRow.length > 0 && d.p.inlineNav === !0 && c !== d.p.selrow && null !== d.p.selrow && (d.p.selrow === b.addParams.rowID ? $(d).jqGrid("delRowData", d.p.selrow) : $(d).jqGrid("restoreRow", d.p.selrow, b.editParams),
      ...
      showAddEditButtons: function() {
          return this.each(function() {
              if (this.grid) {
                  ...
                  $("#" + a + "_ilsave").addClass("ui-state-disabled"),
                  $("#" + a + "_ilcancel").addClass("ui-state-disabled"),
                  $("#" + a + "_iladd").removeClass("ui-state-disabled"),
                  $("#" + a + "_iledit").removeClass("ui-state-disabled")
              }
          })
      }
  }),
                          ...
                          if ("object" != typeof a[e]) {
                              if ("level" === e) {
                                  ...
                                  J[a.level] !== a.text && a.children.length && "_r_Totals" !== a.text && a.level > 0) {
                                      ...
                                      if (a.level - 1 === (j.rowTotals ? 1 : 0) && h > 0) {
                                          var l = i[a.level - 1].groupHeaders[h - 1].numberOfColumns;
                                          l && (k = l + 1 + j.aggregates.length)
                                      }
                                      i[a.level - 1].groupHeaders[h].startColumnName = c[k].name,
                              ...
                              if (a.level === s && "level" === e && s > 0)
                                  if (t > 1) {
                                      var m = 1;
                                      for (b in a.fields)
                                          a.fields.hasOwnProperty(b) && 1 === m && i[s - 1].groupHeaders.push({
                                              startColumnName: b,
                                              numberOfColumns: 1,
                                              titleText: a.text
                                          }),
                                          m++;
                                      i[s - 1].groupHeaders[i[s - 1].groupHeaders.length - 1].numberOfColumns = m - 1
                                  } else
                                      i.splice(s - 1, 1)
                          }
  ...
  $.jgrid.extend({
      setSubGrid: function() {
          return this.each(function() {
              ...
              if (c.p.subGridOptions = $.extend(d, c.p.subGridOptions || {}),
      ...
      addSubGrid: function(a, b) {
          return this.each(function() {
              var c = this;
              if (c.grid) {
                  var d, e, f, g, h, i = function(a, b, d) {
                      var e = $("<td align='" + c.p.subGridModel[0].align[d] + "'></td>").html(b);
                      $(a).append(e)
                  }, j = function(a, b) {
                      var d, e, f, g = $("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), h = $("<tr></tr>");
                      for (e = 0; e < c.p.subGridModel[0].name.length; e++)
                          d = $("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + c.p.direction + "'></th>"),
                      ...
                      $(f.root + " " + f.row, a).each(function() {
                          if (h = $("<tr class='ui-widget-content ui-subtblcell'></tr>"),
                          f.repeatitems === !0)
                      ...
                      var j = $("table:first", c.grid.bDiv).attr("id") + "_";
                      return $("#" + $.jgrid.jqID(j + b)).append(g),
                      c.grid.hDiv.loading = !1,
                      $("#load_" + $.jgrid.jqID(c.p.id)).hide(),
                      !1
                  }, k = function(a, b) {
                      var d, e, f, g, h, j, k = $("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), l = $("<tr></tr>");
                      ...
                      void 0 !== e))
                          for (f = 0; f < e.length; f++) {
                              if (g = e[f],
                              l = $("<tr class='ui-widget-content ui-subtblcell'></tr>"),
                              h.repeatitems === !0)
                                  for (h.cell && (g = g[h.cell]),
                                  j = 0; j < g.length; j++)
                                      i(l, g[j] || "&#160;", j);
                              else {
                                  var m = c.p.subGridModel[0].mapping || c.p.subGridModel[0].name;
                                  if (m.length)
                      ...
                      var n = $("table:first", c.grid.bDiv).attr("id") + "_";
                      return $("#" + $.jgrid.jqID(n + b)).append(k),
                      c.grid.hDiv.loading = !1,
                      $("#load_" + $.jgrid.jqID(c.p.id)).hide(),
                      !1
                  }, l = function(a) {
                      ...
                      if (!c.grid.hDiv.loading)
                          ...
                          case "json":
                              $.ajax($.extend({
                                  ...
                                  complete: function(a) {
                                      "xml" === c.p.subgridtype ? j(a.responseXML, b) : k($.jgrid.parse(a.responseText), b),
                                      a = null
                                  }
                  ...
                  $.each(c.p.colModel, function() {
                      (this.hidden === !0 || "rn" === this.name || "cb" === this.name) && m++
                  });
                  var n = c.rows.length
                    , o = 1;
                  for (void 0 !== b && b > 0 && (o = b,
                  n = b + 1); n > o; )
                      $(c.rows[o]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[o].cells[a]).unbind("click"),
                      $(c.rows[o].cells[a]).bind("click", function() {
                          ...
                          $(this).hasClass("sgcollapsed")) {
                              ...
                              $(b).after("<tr role='row' id='" + e + "_" + d + "_expandedContent' class='ui-subgrid ui-sg-expanded'>" + f + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " + c.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(c.p.colNames.length - 1 - m, 10) + "' class='ui-widget-content subgrid-data'><div id=" + e + "_" + d + " class='tablediv'></div></td></tr>"),
                              $(c).triggerHandler("jqGridSubGridRowExpanded", [e + "_" + d, d]),
                              $.isFunction(c.p.subGridRowExpanded) ? c.p.subGridRowExpanded.call(c, e + "_" + d, d) : l(b)) : h.show().removeClass("ui-sg-collapsed").addClass("ui-sg-expanded"),
                              $(this).html("<a style='cursor:pointer;'><span class='ui-icon " + c.p.subGridOptions.minusicon + "'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded"),
                              ...
                              $(this).html("<a style='cursor:pointer;'><span class='ui-icon " + c.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"),
      ...
      setTreeNode: function(a, b) {
          return this.each(function() {
              ...
              if (c.grid && c.p.treeGrid)
                  for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded; b > a; ) {
                      var r, s = $.jgrid.stripPref(c.p.idPrefix, c.rows[a].id), t = c.p._index[s];
                      j = c.p.data[t],
                      ...
                      i += "<div style='" + ("rtl" === c.p.direction ? "right:" : "left:") + 18 * h + "px;' class='ui-icon ",
                      ...
                      f !== parseInt(c.p.tree_root_level, 10) && (r = $(c).jqGrid("isVisibleNode", j),
                      r || $(c.rows[a]).css("display", "none")),
      ...
      setTreeGrid: function() {
          return this.each(function() {
              ...
              if (e.p.treeGrid) {
                  ...
                  e.p.rowList = [],
                  e.p.expColInd = 0,
                  a = "ui-icon-triangle-1-" + ("rtl" === e.p.direction ? "w" : "e"),
  ...
  var s = 0
    ...
    , m = function(a) {
      var b = H[A[A.length - 1]]
        , c = !$(a.target).parents(".jqmID" + b.s)[0] && !$(a.target).parents().hasClass('ui-multiselect-filter') && $(a.target).attr("id") != "idleTimeoutPwd";
  ...
  $.fn.fmatter.actions = function(a, b) {
      var c, d = {
          ...
          delbutton: !0,
          editformbutton: !1
      }, e = b.rowId, f = "", g = $.jgrid.getRegional(this, "nav");
      return void 0 !== b.colModel.formatoptions && (d = $.extend(d, b.colModel.formatoptions)),
      void 0 === e || $.fmatter.isEmpty(e) ? "" : (d.editformbutton ? (c = "id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ",
      f += "<div title='" + g.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + c + "><span class='ui-icon ui-icon-pencil'></span></div>") : d.editbutton && (c = "id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ",
      f += "<div title='" + g.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + c + "><span class='ui-icon ui-icon-pencil'></span></div>"),
      d.delbutton && (c = "id='jDeleteButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ",
      f += "<div title='" + g.deltitle + "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' " + c + "><span class='ui-icon ui-icon-trash'></span></div>"),
      c = "id='jSaveButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ",
      f += "<div title='" + g.savetitle + "' style='float:left;display:none' class='ui-pg-div ui-inline-save' " + c + "><span class='ui-icon ui-icon-disk'></span></div>",
      c = "id='jCancelButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ",
      f += "<div title='" + g.canceltitle + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' " + c + "><span class='ui-icon ui-icon-cancel'></span></div>",
